...
MAAS provides a [library of drivers](https://maas.io/docs/reference-power-drivers), from the obscure to the widely-used IPMI and Redfish drivers. This library likely has the driver you need. If not, a custom power driver known as the WebHook may help. WebHook supports more obscure BMC protocols and manual power types.
