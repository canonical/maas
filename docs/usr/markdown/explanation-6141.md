...
- Discover all the ways you can [customize](https://canonical.com/maas/docs/about-machine-customization) deployment to suit your use case.
...
- [Region and rack controllers](https://canonical.com/maas/docs/how-to-manage-controllers#p-9026-enable-ha) do the heavy-lifting of maintaining your data centers.
...
- Take stock of where we stand with [MAAS performance](https://canonical.com/maas/docs/about-maas-performance).
