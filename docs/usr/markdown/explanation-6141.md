<!-- Lead with the "What" in plain English, avoid comparatives, maybes, promises; state the  -->
<!-- benefit or purpose of each proposed action -->
...
<!-- Bold term, followed by link, followed by action-oriented present tense instructions. -->
<!-- Stay away from lead-in, outros, and filler patter -->
...
* **LXD projects**: [LXD projects](https://canonical.com/maas/docs/about-deploying-machines) -- Use LXD projects to run lightweight virtual machines on demand.
