...
|:-----|:-----|:-----|:-----|
| IP for Powertek PDU | IP address of unit | | Required |
| PDU (1-16) | Powertek PDU number | | Required |
| Outlet (1-72) | Powertek outlet number | | Required |
| SNMP Write community | SNMP write community string | | Required |
| PDU version | Powertek PDU version | `Version 1` | Required |
| | | `Version 2` | |
...
All parameters are entered as `key=value`, e.g., `power_type=powertek`. The MAAS CLI will refuse the request with informative errors if required parameters are excluded.

| Parameter | Description | Choices | Required |
|:-----|:-----|:-----|:-----|
| `power_type` | `powertek` | | Required |
| `power_address` | IP address of unit | | Required |
| `pdu_number` | Powertek PDU number | | Required |
| `node_outlet` | Powertek outlet number | | Required |
| `power_community` | SNMP write community string | | Required |
| `pdu_version` | Powertek PDU version | `1` (`Version 1`) | Required |
| | | `2` (`Version 2`) | |
