...
METRICS_DEFINITIONS = [
    ...
    MetricDefinition(
        ...
        'HTTP request query latency', _HTTP_REQUEST_LABELS),
    MetricDefinition(
    ...
    MetricDefinition(
        'Histogram', 'maas_websocket_call_query_count',
        'Websocket call query count', _WEBSOCKET_CALL_LABELS,
        buckets=[10, 25, 50, 100, 200, 500]),
    MetricDefinition(
        'Histogram', 'maas_websocket_call_query_latency',
        'HTTP request query latency', _WEBSOCKET_CALL_LABELS),
    # Common metrics
    *node_metrics_definitions()
]
