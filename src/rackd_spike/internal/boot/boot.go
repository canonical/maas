...
var (
	BootMethodRegistry = map[string]BootMethod{
		...
		"uefi_amd64_tftp": BootMethod{
			Name:           "uefi_amd64_tftp",
			ArchOctet:      "00:07",
			BootloaderPath: "bootx64.efi",
		},
		"uefi_amd64_http": BootMethod{
		...
		"uefi_ebc_tftp": BootMethod{
			Name:           "uefi_ebc_tftp",
			BootloaderPath: "bootx64.efi",
			ArchOctet:      "00:09",
		},
		"uefi_arm64_tftp": BootMethod{
			Name:           "uefi_arm64_tftp",
			BootloaderPath: "bootaa64.efi",
			ArchOctet:      "00:0B",
		},
		"uefi_arm64_http": BootMethod{
		...
		"open-firmware-ppc64el": BootMethod{
