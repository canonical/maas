...
function maasBootImagesStatus(BootResourcesManager) {
    return {
        restrict: "E",
        scope: {},
        template: [
...
function maasBootImages($timeout, BootResourcesManager,
...
maas.directive('maasBootImagesStatus', maasBootImagesStatus);
maas.directive('maasBootImages', maasBootImages);
