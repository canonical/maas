...
describe("maasSshKeys", function() {
    ...
    describe("importKeys", function() {
        ...
        it("calls deleteItem on all keys", function() {
            ...
            expect(SSHKeysManager.deleteItem.calls.argsFor(0)).toEqual(
                [obj.keys[0]]);
            expect(SSHKeysManager.deleteItem.calls.argsFor(1)).toEqual(
                [obj.keys[1]]);
        });
    });
});
