...
function cacheControllerStatus($templateCache) {
...
function maasControllerStatus(ControllersManager, ServicesManager) {
    return {
        restrict: "A",
        scope: {
...
maas.run(cacheControllerStatus);
maas.directive('maasControllerStatus', maasControllerStatus)
