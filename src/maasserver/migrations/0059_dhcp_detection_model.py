...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeGroupInterface.foreign_dhcp_ip'
        db.add_column(u'maasserver_nodegroupinterface', 'foreign_dhcp_ip',
                      self.gf('django.db.models.fields.GenericIPAddressField')(default=None, max_length=39, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeGroupInterface.foreign_dhcp_ip'
        db.delete_column(u'maasserver_nodegroupinterface', 'foreign_dhcp_ip')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'2a4a64c6-5585-11e3-8188-0026c71eea0e'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-2a48f01e-5585-11e3-8188-0026c71eea0e'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'maasserver.nodegroupinterface': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'foreign_dhcp_ip': ('django.db.models.fields.GenericIPAddressField', [], {'default': 'None', 'max_length': '39', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1385351617L'}),
