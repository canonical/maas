...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MACAddress.cluster_interface'
        db.add_column(u'maasserver_macaddress', 'cluster_interface',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['maasserver.NodeGroupInterface'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MACAddress.cluster_interface'
        db.delete_column(u'maasserver_macaddress', 'cluster_interface_id')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'f6095be0-ebb1-11e3-a0df-002215205ce8'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-f60cd900-ebb1-11e3-a0df-002215205ce8'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1401863531L'}),
