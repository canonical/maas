...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'maasserver_nodegroupinterface', 'ip_range_high', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, unique=True, null=True))
        ...
        db.alter_column(u'maasserver_nodegroupinterface', 'ip_range_low', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NodeGroupInterface.ip_range_high'
        db.alter_column(u'maasserver_nodegroupinterface', 'ip_range_high', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15, null=True))

        # Changing field 'NodeGroupInterface.ip'
        db.alter_column(u'maasserver_nodegroupinterface', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'NodeGroupInterface.ip_range_low'
        db.alter_column(u'maasserver_nodegroupinterface', 'ip_range_low', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15, null=True))

        # Changing field 'NodeGroupInterface.subnet_mask'
        db.alter_column(u'maasserver_nodegroupinterface', 'subnet_mask', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'NodeGroupInterface.broadcast_ip'
        db.alter_column(u'maasserver_nodegroupinterface', 'broadcast_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'NodeGroupInterface.router_ip'
        db.alter_column(u'maasserver_nodegroupinterface', 'router_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-c30c2114-0959-11e2-aa17-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1348829190L'}),
