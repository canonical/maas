...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'maasserver_network', (
        ...
        db.create_table(u'maasserver_macaddress', (
        ...
        db.send_create_signal(u'maasserver', ['MACAddress'])

        # Adding M2M table for field networks on 'MACAddress'
        db.create_table(u'maasserver_macaddress_networks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('macaddress', models.ForeignKey(orm[u'maasserver.macaddress'], null=False)),
            ('network', models.ForeignKey(orm[u'maasserver.network'], null=False))
        ))
        db.create_unique(u'maasserver_macaddress_networks', ['macaddress_id', 'network_id'])
