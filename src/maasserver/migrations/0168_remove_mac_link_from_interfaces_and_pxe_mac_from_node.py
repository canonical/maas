...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'maasserver_node', 'pxe_mac_id')

        # Deleting field 'Interface.mac'
        db.delete_column(u'maasserver_interface', 'mac_id')


    def backwards(self, orm):
        # Adding field 'Node.pxe_mac'
        db.add_column(u'maasserver_node', 'pxe_mac',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', on_delete=models.SET_NULL, default=None, to=orm['maasserver.MACAddress'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Interface.mac'
        db.add_column(u'maasserver_interface', 'mac',
