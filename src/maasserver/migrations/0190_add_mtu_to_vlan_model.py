...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maasserver_vlan', 'mtu',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'maasserver_vlan', 'mtu')
    ...
    models = {
        ...
        u'maasserver.interface': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
            'vlan': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['maasserver.VLAN']", 'on_delete': 'models.PROTECT'})
        },
