...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maasserver_staticipaddress', 'subnet',
        ...
        db.alter_column(u'maasserver_staticipaddress', 'ip', self.gf('maasserver.fields.MAASIPAddressField')(max_length=39, unique=True, null=True))
        # Adding M2M table for field ip_addresses on 'Interface'
        db.create_table(u'maasserver_interface_ip_addresses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('interface', models.ForeignKey(orm[u'maasserver.interface'], null=False)),
            ('staticipaddress', models.ForeignKey(orm[u'maasserver.staticipaddress'], null=False))
        ))
        db.create_unique(u'maasserver_interface_ip_addresses', ['interface_id', 'staticipaddress_id'])


    def backwards(self, orm):
        # Deleting field 'StaticIPAddress.subnet'
        db.delete_column(u'maasserver_staticipaddress', 'subnet_id')
    ...
    models = {
        ...
        u'maasserver.filesystem': {
            ...
            'block_device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['maasserver.BlockDevice']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'partition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['maasserver.Partition']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        u'maasserver.macaddress': {
            ...
            'cluster_interface': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['maasserver.NodeGroupInterface']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'maasserver.node': {
            ...
            'pxe_mac': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['maasserver.MACAddress']", 'blank': 'True', 'null': 'True'}),
