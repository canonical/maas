...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeGroup.dhcp_interface'
        db.add_column(u'maasserver_nodegroup', 'dhcp_interface', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeGroup.dhcp_interface'
        db.delete_column(u'maasserver_nodegroup', 'dhcp_interface')
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-4915c99a-f58c-11e1-a13a-002608dc6120'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'maasserver.nodegroup': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'dhcp_interface': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1346651866L'}),
