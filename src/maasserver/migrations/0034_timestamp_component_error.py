...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComponentError.created'
        db.add_column(u'maasserver_componenterror', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 29, 0, 0)),
                      keep_default=False)

        # Adding field 'ComponentError.updated'
        db.add_column(u'maasserver_componenterror', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 29, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComponentError.created'
        db.delete_column(u'maasserver_componenterror', 'created')

        # Deleting field 'ComponentError.updated'
        db.delete_column(u'maasserver_componenterror', 'updated')
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-156b5bee-0998-11e2-aa86-002608dc6120'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1348855910L'}),
