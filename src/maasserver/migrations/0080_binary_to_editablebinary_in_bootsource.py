...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BootSource.keyring_data'
        db.alter_column(u'maasserver_bootsource', 'keyring_data', self.gf('maasserver.fields.EditableBinaryField')())

    def backwards(self, orm):

        # Changing field 'BootSource.keyring_data'
        db.alter_column(u'maasserver_bootsource', 'keyring_data', self.gf('django.db.models.fields.BinaryField')())
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'a2098728-df5d-11e3-8572-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-a2064126-df5d-11e3-8572-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1400507898L'}),
