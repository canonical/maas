...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.boot_cluster_ip'
        db.add_column('maasserver_node', 'boot_cluster_ip',
                      self.gf('maasserver.fields.MAASIPAddressField')(default=None, max_length=39, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.boot_cluster_ip'
        db.delete_column('maasserver_node', 'boot_cluster_ip')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'cd2a9c56-4cfa-11e5-b538-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-cd2af868-4cfa-11e5-b538-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1440707576L'}),
