...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='children', null=True, blank=True, to=orm['maasserver.Node']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.parent'
        db.delete_column('maasserver_node', 'parent_id')
