...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('maasserver_nodegroupinterface', ['interface', 'nodegroup_id'])

        # Adding unique constraint on 'NodeGroupInterface', fields ['nodegroup', 'name']
        db.create_unique('maasserver_nodegroupinterface', ['nodegroup_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'NodeGroupInterface', fields ['nodegroup', 'name']
        db.delete_unique('maasserver_nodegroupinterface', ['nodegroup_id', 'name'])

        # Adding unique constraint on 'NodeGroupInterface', fields ['interface', 'nodegroup']
        db.create_unique('maasserver_nodegroupinterface', ['interface', 'nodegroup_id'])
