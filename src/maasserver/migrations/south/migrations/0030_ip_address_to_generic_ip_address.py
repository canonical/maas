...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_nodegroupinterface', 'ip_range_high', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, unique=True, null=True))
        ...
        db.alter_column('maasserver_nodegroupinterface', 'ip_range_low', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NodeGroupInterface.ip_range_high'
        db.alter_column('maasserver_nodegroupinterface', 'ip_range_high', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15, null=True))

        # Changing field 'NodeGroupInterface.ip'
        db.alter_column('maasserver_nodegroupinterface', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'NodeGroupInterface.ip_range_low'
        db.alter_column('maasserver_nodegroupinterface', 'ip_range_low', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15, null=True))

        # Changing field 'NodeGroupInterface.subnet_mask'
        db.alter_column('maasserver_nodegroupinterface', 'subnet_mask', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'NodeGroupInterface.broadcast_ip'
        db.alter_column('maasserver_nodegroupinterface', 'broadcast_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'NodeGroupInterface.router_ip'
        db.alter_column('maasserver_nodegroupinterface', 'router_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))
