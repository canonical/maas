...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_blockdevice', 'tags',
                      self.gf('djorm_pgarray.fields.ArrayField')(default='{}', dbtype='text', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlockDevice.tags'
        db.delete_column('maasserver_blockdevice', 'tags')
