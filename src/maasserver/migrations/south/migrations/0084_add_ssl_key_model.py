...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SSLKey'
        db.create_table('maasserver_sslkey', (
        ...
        db.send_create_signal('maasserver', ['SSLKey'])

        # Adding unique constraint on 'SSLKey', fields ['user', 'key']
        db.create_unique('maasserver_sslkey', ['user_id', 'key'])


    def backwards(self, orm):
        # Removing unique constraint on 'SSLKey', fields ['user', 'key']
        db.delete_unique('maasserver_sslkey', ['user_id', 'key'])

        # Deleting model 'SSLKey'
        db.delete_table('maasserver_sslkey')
