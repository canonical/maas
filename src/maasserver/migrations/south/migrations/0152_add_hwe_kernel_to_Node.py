...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.min_hwe_kernel'
        db.add_column('maasserver_node', 'min_hwe_kernel',
                      self.gf('django.db.models.fields.CharField')(max_length=31, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.hwe_kernel'
        db.add_column('maasserver_node', 'hwe_kernel',
                      self.gf('django.db.models.fields.CharField')(max_length=31, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.min_hwe_kernel'
        db.delete_column('maasserver_node', 'min_hwe_kernel')

        # Deleting field 'Node.hwe_kernel'
        db.delete_column('maasserver_node', 'hwe_kernel')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'74adeafa-2f2d-11e5-9974-10c37b9cd621'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-74b5c590-2f2d-11e5-9974-10c37b9cd621'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1437430796L'}),
