...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'maasserver_node', 'min_hwe_kernel')

        # Deleting field 'Node.hwe_kernel'
        db.delete_column(u'maasserver_node', 'hwe_kernel')
