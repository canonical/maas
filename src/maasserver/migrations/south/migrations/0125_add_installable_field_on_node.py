...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'installable',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


        # Changing field 'Node.architecture'
        db.alter_column('maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(max_length=31, null=True))

    def backwards(self, orm):
        # Deleting field 'Node.installable'
        db.delete_column('maasserver_node', 'installable')


        # Changing field 'Node.architecture'
        db.alter_column('maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(default='', max_length=31))
