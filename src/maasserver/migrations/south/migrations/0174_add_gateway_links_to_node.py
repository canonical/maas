...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maasserver_node', 'gateway_link_ipv4',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', on_delete=models.SET_NULL, default=None, to=orm['maasserver.StaticIPAddress'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Node.gateway_link_ipv6'
        db.add_column(u'maasserver_node', 'gateway_link_ipv6',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', on_delete=models.SET_NULL, default=None, to=orm['maasserver.StaticIPAddress'], blank=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'maasserver_node', 'gateway_link_ipv4_id')

        # Deleting field 'Node.gateway_link_ipv6'
        db.delete_column(u'maasserver_node', 'gateway_link_ipv6_id')
