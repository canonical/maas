...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Node.gateway_link_ipv4'
        db.delete_column('maasserver_node', 'gateway_link_ipv4_id')

        # Deleting field 'Node.gateway_link_ipv6'
        db.delete_column('maasserver_node', 'gateway_link_ipv6_id')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'4e4b80c2-58a2-11e5-a0e6-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-4e4cd59e-58a2-11e5-a0e6-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1441988982L'}),
