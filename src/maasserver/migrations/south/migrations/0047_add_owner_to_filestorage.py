...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('maasserver_filestorage', ['filename'])

        # Adding field 'FileStorage.owner'
        db.add_column('maasserver_filestorage', 'owner',
        ...
        db.create_unique('maasserver_filestorage', ['owner_id', 'filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'FileStorage', fields ['owner', 'filename']
        db.delete_unique('maasserver_filestorage', ['owner_id', 'filename'])

        # Deleting field 'FileStorage.owner'
        db.delete_column('maasserver_filestorage', 'owner_id')

        # Adding unique constraint on 'FileStorage', fields ['filename']
        db.create_unique('maasserver_filestorage', ['filename'])
