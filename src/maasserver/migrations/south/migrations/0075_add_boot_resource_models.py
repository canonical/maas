...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_bootsourceselection', (
            ...
            ('release', self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True, blank=True)),
            ('arches', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='text', null=True, blank=True)),
            ('subarches', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='text', null=True, blank=True)),
            ('labels', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='text', null=True, blank=True)),
        ))
        db.send_create_signal('maasserver', ['BootSourceSelection'])

        # Adding model 'BootSource'
        db.create_table('maasserver_bootsource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('maasserver', ['BootSource'])


    def backwards(self, orm):
        # Deleting model 'BootSourceSelection'
        db.delete_table('maasserver_bootsourceselection')

        # Deleting model 'BootSource'
        db.delete_table('maasserver_bootsource')
