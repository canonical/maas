...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Filesystem', fields ['partition']
        db.delete_unique('maasserver_filesystem', ['partition_id'])

        # Removing unique constraint on 'Filesystem', fields ['block_device']
        db.delete_unique('maasserver_filesystem', ['block_device_id'])

        # Removing unique constraint on 'Filesystem', fields ['uuid']
        db.delete_unique('maasserver_filesystem', ['uuid'])

        # Adding field 'Filesystem.acquired'
        db.add_column('maasserver_filesystem', 'acquired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'Filesystem', fields ['acquired', 'partition']
        db.create_unique('maasserver_filesystem', ['acquired', 'partition_id'])

        # Adding unique constraint on 'Filesystem', fields ['block_device', 'acquired']
        db.create_unique('maasserver_filesystem', ['block_device_id', 'acquired'])


    def backwards(self, orm):
        # Removing unique constraint on 'Filesystem', fields ['block_device', 'acquired']
        db.delete_unique('maasserver_filesystem', ['block_device_id', 'acquired'])

        # Removing unique constraint on 'Filesystem', fields ['acquired', 'partition']
        db.delete_unique('maasserver_filesystem', ['acquired', 'partition_id'])

        # Deleting field 'Filesystem.acquired'
        db.delete_column('maasserver_filesystem', 'acquired')

        # Adding unique constraint on 'Filesystem', fields ['uuid']
        db.create_unique('maasserver_filesystem', ['uuid'])

        # Adding unique constraint on 'Filesystem', fields ['block_device']
        db.create_unique('maasserver_filesystem', ['block_device_id'])

        # Adding unique constraint on 'Filesystem', fields ['partition']
        db.create_unique('maasserver_filesystem', ['partition_id'])
    ...
    models = {
        ...
        'maasserver.fannetwork': {
            ...
            'host_reserve': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'8fe909f8-6236-11e5-9450-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-8fea2b58-6236-11e5-9450-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1443042218L'}),
