...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilesystemGroup.cache_mode'
        db.add_column('maasserver_filesystemgroup', 'cache_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilesystemGroup.cache_mode'
        db.delete_column('maasserver_filesystemgroup', 'cache_mode')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'23eabaa2-30b9-11e5-a0df-525400023619'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-23efa314-30b9-11e5-a0df-525400023619'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1437600742L'}),
