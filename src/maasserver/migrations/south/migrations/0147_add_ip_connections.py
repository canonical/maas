...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticIPAddress.subnet'
        db.add_column('maasserver_staticipaddress', 'subnet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.Subnet'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'StaticIPAddress.ip'
        db.alter_column('maasserver_staticipaddress', 'ip', self.gf('maasserver.fields.MAASIPAddressField')(max_length=39, unique=True, null=True))
        # Adding M2M table for field ip_addresses on 'Interface'
        db.create_table('maasserver_interface_ip_addresses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('interface', models.ForeignKey(orm['maasserver.interface'], null=False)),
            ('staticipaddress', models.ForeignKey(orm['maasserver.staticipaddress'], null=False))
        ))
        db.create_unique('maasserver_interface_ip_addresses', ['interface_id', 'staticipaddress_id'])


    def backwards(self, orm):
        # Deleting field 'StaticIPAddress.subnet'
        db.delete_column('maasserver_staticipaddress', 'subnet_id')


        # User chose to not deal with backwards NULL issues for 'StaticIPAddress.ip'
        raise RuntimeError("Cannot reverse this migration. 'StaticIPAddress.ip' and its values cannot be restored.")
        # Removing M2M table for field ip_addresses on 'Interface'
        db.delete_table('maasserver_interface_ip_addresses')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'a6d7ef74-1e3b-11e5-a2ed-3c970e0e56dc'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-a6d512cc-1e3b-11e5-a2ed-3c970e0e56dc'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1435567670L'}),
