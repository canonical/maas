...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_bootsource', 'keyring_data', self.gf('maasserver.fields.EditableBinaryField')())

    def backwards(self, orm):

        # Changing field 'BootSource.keyring_data'
        db.alter_column('maasserver_bootsource', 'keyring_data', self.gf('django.db.models.fields.BinaryField')())
