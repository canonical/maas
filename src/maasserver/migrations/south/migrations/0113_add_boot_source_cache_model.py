...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BootSourceCache'
        db.create_table(u'maasserver_bootsourcecache', (
            ...
            ('subarch', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('release', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'maasserver', ['BootSourceCache'])


    def backwards(self, orm):
        # Deleting model 'BootSourceCache'
        db.delete_table(u'maasserver_bootsourcecache')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'7f994b9a-45b2-11e4-a8ac-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-7f99ec08-45b2-11e4-a8ac-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1411759367L'}),
