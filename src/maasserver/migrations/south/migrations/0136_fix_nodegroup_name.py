...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_nodegroup', 'name', self.gf('maasserver.models.nodegroup.DomainNameField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'NodeGroup.name'
        db.alter_column('maasserver_nodegroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))
