...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NodeGroup.name'
        db.alter_column(u'maasserver_nodegroup', 'name', self.gf('maasserver.models.nodegroup.DomainNameField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'NodeGroup.name'
        db.alter_column(u'maasserver_nodegroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'c97d2ea8-fd80-11e4-b109-80fa5b08ed9b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-c97f1074-fd80-11e4-b109-80fa5b08ed9b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1431969030L'}),
