...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'maasserver_bootimage', ['nodegroup_id', 'osystem', 'architecture', 'subarchitecture', 'release', 'purpose', 'label'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'maasserver_bootimage', (
            ...
            ('xinstall_type', self.gf('django.db.models.fields.CharField')(default=u'', max_length=30, null=True, blank=True)),
            ('xinstall_path', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, null=True, blank=True)),
            ...
            ('label', self.gf('django.db.models.fields.CharField')(default=u'release', max_length=255)),
        ...
        db.create_unique(u'maasserver_bootimage', ['nodegroup_id', 'osystem', 'architecture', 'subarchitecture', 'release', 'purpose', 'label'])
