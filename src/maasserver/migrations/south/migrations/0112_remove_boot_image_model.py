...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BootImage', fields ['nodegroup', 'osystem', 'architecture', 'subarchitecture', 'release', 'purpose', 'label']
        db.delete_unique('maasserver_bootimage', ['nodegroup_id', 'osystem', 'architecture', 'subarchitecture', 'release', 'purpose', 'label'])

        # Deleting model 'BootImage'
        db.delete_table('maasserver_bootimage')


    def backwards(self, orm):
        # Adding model 'BootImage'
        db.create_table('maasserver_bootimage', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('xinstall_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True, blank=True)),
            ('xinstall_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ...
            ('supported_subarches', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('osystem', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('label', self.gf('django.db.models.fields.CharField')(default='release', max_length=255)),
        ...
        db.send_create_signal('maasserver', ['BootImage'])

        # Adding unique constraint on 'BootImage', fields ['nodegroup', 'osystem', 'architecture', 'subarchitecture', 'release', 'purpose', 'label']
        db.create_unique('maasserver_bootimage', ['nodegroup_id', 'osystem', 'architecture', 'subarchitecture', 'release', 'purpose', 'label'])
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'802d40a2-434b-11e4-95a2-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-802c463e-434b-11e4-95a2-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1411495227L'}),
