...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # MAAS no longer works with releases prior to trusty for
        # enlistment.
        config = orm['maasserver.Config'].objects.filter(
            name='commissioning_distro_series')
        if config:
            config.update(value='trusty')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'544bf40c-952b-11e3-a340-0026c71eea0e'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-544df52c-952b-11e3-a340-0026c71eea0e'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1392349907L'}),
