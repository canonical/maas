...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Network.default_gateway'
        db.add_column(u'maasserver_network', 'default_gateway',
                      self.gf('maasserver.fields.MAASIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Network.default_gateway'
        db.delete_column(u'maasserver_network', 'default_gateway')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'8b7df110-3179-11e4-ae4e-0026c71eea0e'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-8b7fc760-3179-11e4-ae4e-0026c71eea0e'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1409535882L'}),
