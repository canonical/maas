...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BootImage.created'
        db.add_column(u'maasserver_bootimage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 01, 0, 0)),
                      keep_default=False)

        # Adding field 'BootImage.updated'
        db.add_column(u'maasserver_bootimage', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 01, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BootImage.created'
        db.delete_column(u'maasserver_bootimage', 'created')

        # Deleting field 'BootImage.updated'
        db.delete_column(u'maasserver_bootimage', 'updated')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'27575c38-b4fd-11e3-8df2-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-2751e262-b4fd-11e3-8df2-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1395848238L'}),
