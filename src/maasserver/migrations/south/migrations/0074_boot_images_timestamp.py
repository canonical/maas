...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_bootimage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 0o1, 0, 0)),
                      keep_default=False)

        # Adding field 'BootImage.updated'
        db.add_column('maasserver_bootimage', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 0o1, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('maasserver_bootimage', 'created')

        # Deleting field 'BootImage.updated'
        db.delete_column('maasserver_bootimage', 'updated')
