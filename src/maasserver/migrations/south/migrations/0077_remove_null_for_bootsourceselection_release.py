...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_bootsourceselection', 'release', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'BootSourceSelection.release'
        db.alter_column('maasserver_bootsourceselection', 'release', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
