...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_nodegroup', 'uuid', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=36), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeGroup.uuid'
        db.delete_column('maasserver_nodegroup', 'uuid')
