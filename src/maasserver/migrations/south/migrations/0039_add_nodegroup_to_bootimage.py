...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('maasserver_bootimage', ['subarchitecture', 'release', 'architecture', 'purpose'])

        # Adding field 'BootImage.nodegroup'
        db.add_column('maasserver_bootimage', 'nodegroup',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('maasserver_bootimage', 'nodegroup_id')

        # Adding unique constraint on 'BootImage', fields ['subarchitecture', 'release', 'architecture', 'purpose']
        db.create_unique('maasserver_bootimage', ['subarchitecture', 'release', 'architecture', 'purpose'])
