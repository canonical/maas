...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Drop the all IP address with type DHCP. It used to be used by the
        # lease parser but now it uses DISCOVERED. No need to migration this
        # data as the cluster will upload an entire leases file to the region.
        # DHCP = 5
        orm['maasserver.StaticIPAddress'].objects.filter(alloc_type=5).delete()

    def backwards(self, orm):
        # No way of going backwards and we don't need to. As the lease parser
        # will create the DHCP entries again.
        pass
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'd91f3f66-5b1a-11e5-9284-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-d91d7e2e-5b1a-11e5-9284-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1442260657L'}),
