...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Drop the partial unique constraint on mac_id.
        db.execute("DROP INDEX maasserver_interface_mac_id_name_idx")

        # Deleting field 'Node.pxe_mac'
        db.delete_column('maasserver_node', 'pxe_mac_id')

        # Deleting field 'Interface.mac'
        db.delete_column('maasserver_interface', 'mac_id')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'fb9b9576-4acb-11e5-a108-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-fb9bd752-4acb-11e5-a108-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1440467566L'}),
