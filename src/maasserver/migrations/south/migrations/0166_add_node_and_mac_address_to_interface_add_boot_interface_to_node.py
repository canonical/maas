...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maasserver_node', 'boot_interface',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', on_delete=models.SET_NULL, default=None, to=orm['maasserver.Interface'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Interface.node'
        db.add_column(u'maasserver_interface', 'node',
        ...
        db.add_column(u'maasserver_interface', 'mac_address',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'maasserver_node', 'boot_interface_id')

        # Deleting field 'Interface.node'
        db.delete_column(u'maasserver_interface', 'node_id')

        # Deleting field 'Interface.mac_address'
        db.delete_column(u'maasserver_interface', 'mac_address')
