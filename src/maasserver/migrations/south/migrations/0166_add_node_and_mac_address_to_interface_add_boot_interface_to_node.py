...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Node.boot_interface'
        db.delete_column('maasserver_node', 'boot_interface_id')

        # Deleting field 'Interface.node'
        db.delete_column('maasserver_interface', 'node_id')

        # Deleting field 'Interface.mac_address'
        db.delete_column('maasserver_interface', 'mac_address')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'd181e7f0-4aca-11e5-acd3-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-d1811f14-4aca-11e5-acd3-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1440467065L'}),
