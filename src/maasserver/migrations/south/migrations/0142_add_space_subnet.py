...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Space'
        db.create_table(u'maasserver_space', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
        ))
        db.send_create_signal(u'maasserver', ['Space'])

        # Adding model 'Subnet'
        db.create_table(u'maasserver_subnet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ...
            ('dns_servers', self.gf('djorm_pgarray.fields.ArrayField')(default={}, dbtype=u'text', null=True, blank=True)),
        ))
        db.send_create_signal(u'maasserver', ['Subnet'])

        # Adding unique constraint on 'Subnet', fields ['name', 'space']
        db.create_unique(u'maasserver_subnet', ['name', 'space_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subnet', fields ['name', 'space']
        db.delete_unique(u'maasserver_subnet', ['name', 'space_id'])

        # Deleting model 'Space'
        db.delete_table(u'maasserver_space')

        # Deleting model 'Subnet'
        db.delete_table(u'maasserver_subnet')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'bc8c7430-18fe-11e5-8aa3-3c970e0e56dc'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-bc8b6b3a-18fe-11e5-8aa3-3c970e0e56dc'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1434991806L'}),
