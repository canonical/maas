...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_partitiontable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('table_type', self.gf('django.db.models.fields.CharField')(default='GPT', max_length=20)),
            ('block_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.BlockDevice'])),
        ))
        db.send_create_signal('maasserver', ['PartitionTable'])


    def backwards(self, orm):
        # Deleting model 'PartitionTable'
        db.delete_table('maasserver_partitiontable')
