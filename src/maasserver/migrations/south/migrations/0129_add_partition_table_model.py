...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartitionTable'
        db.create_table(u'maasserver_partitiontable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('table_type', self.gf('django.db.models.fields.CharField')(default=u'GPT', max_length=20)),
            ('block_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.BlockDevice'])),
        ))
        db.send_create_signal(u'maasserver', ['PartitionTable'])


    def backwards(self, orm):
        # Deleting model 'PartitionTable'
        db.delete_table(u'maasserver_partitiontable')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'b95fb640-c73d-11e4-b879-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-b95f016e-c73d-11e4-b879-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1426002864L'}),
