...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.enable_ssh'
        db.add_column('maasserver_node', 'enable_ssh',
    ...
    def backwards(self, orm):
        # Deleting field 'Node.enable_ssh'
        db.delete_column('maasserver_node', 'enable_ssh')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'3ba44986-5bb3-11e5-9f58-7c7a9140484f'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-3ba0c5fe-5bb3-11e5-9f58-7c7a9140484f'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1442326105L'}),
