...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'power_parameters', self.gf('maasserver.fields.JSONObjectField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.power_parameters'
        db.delete_column('maasserver_node', 'power_parameters')
