...
# -*- coding: utf-8 -*-            for ngi in orm['maasserver.NodeGroupInterface'].objects.filter(
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Progressively overwrite the Subnet gateway_ip, in case of overlaps.
        # That is, prefer NodeGroupInterfaces with "more management".
        # (because they'll be overwritten last.)
        for management in [0, 1, 2]:
            for ngi in orm['maasserver.NodeGroupInterface'].objects.filter(
                    management=management):
                if ngi.subnet is not None and ngi.router_ip:
                    ngi.subnet.gateway_ip = ngi.router_ip
                    ngi.subnet.save()

    def backwards(self, orm):
        for subnet in orm['maasserver.Subnet'].objects.all():
            for ngi in orm['maasserver.NodeGroupInterface'].objects.filter(
                    subnet=subnet):
                ngi.router_ip = subnet.gateway_ip
                ngi.save()
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'1cdeaf50-539d-11e5-b158-4851b77bf5f2'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-1cdf2480-539d-11e5-b158-4851b77bf5f2'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1441436996L'}),
