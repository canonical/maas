...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'power_state_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


        # Changing field 'Node.power_parameters'
        db.alter_column('maasserver_node', 'power_parameters', self.gf('maasserver.fields.JSONObjectField')(max_length=32768))

    def backwards(self, orm):
        # Deleting field 'Node.power_state_updated'
        db.delete_column('maasserver_node', 'power_state_updated')


        # Changing field 'Node.power_parameters'
        db.alter_column('maasserver_node', 'power_parameters', self.gf('maasserver.fields.JSONObjectField')())
