...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('maasserver_vlan', ['vid', 'fabric_id'])

        # Adding unique constraint on 'VLAN', fields ['name', 'fabric']
        db.create_unique('maasserver_vlan', ['name', 'fabric_id'])

        # Adding model 'Fabric'
        db.create_table('maasserver_fabric', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
        ))
        db.send_create_signal('maasserver', ['Fabric'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('maasserver_vlan', ['vid', 'fabric_id'])

        # Deleting model 'VLAN'
        db.delete_table('maasserver_vlan')

        # Deleting model 'Fabric'
        db.delete_table('maasserver_fabric')
