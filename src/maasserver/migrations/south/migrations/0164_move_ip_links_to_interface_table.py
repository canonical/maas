...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        helper = import_module(
            'maasserver.models.migrations.move_ip_links_helper')
        helper._migrate_links_forward(
            orm['maasserver.MACAddress'], orm['maasserver.Interface'])
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'882fbc74-4603-11e5-850e-80fa5b0c464e'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-882e1680-4603-11e5-850e-80fa5b0c464e'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1439941668L'}),
