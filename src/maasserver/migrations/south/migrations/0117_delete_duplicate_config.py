...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Delete duplicated config items: only keep the most recent one."
        duplicate_configs = (
            orm['maasserver.Config'].objects.values(
                "name").annotate(Count("id")).order_by().filter(id__count__gte=2))
        for duplicate_config in duplicate_configs:
            duplicate_key = duplicate_config['name']
            # Remove old config values: just keep the most recent one.
            most_recent_config_id = (
                orm['maasserver.Config'].objects.filter(
                    name=duplicate_key).order_by('-id')[0].id)
            old_configs = (
                orm['maasserver.Config'].objects.filter(
                    name=duplicate_key).exclude(id=most_recent_config_id))
            old_configs.delete()
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'4d2d6088-6a4c-11e4-b2e5-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-4d2e796e-6a4c-11e4-b2e5-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1415783666L'}),
