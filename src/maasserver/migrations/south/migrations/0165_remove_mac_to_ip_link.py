...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('maasserver_macstaticipaddresslink', ['ip_address_id', 'mac_address_id'])

        # Deleting model 'MACStaticIPAddressLink'
        db.delete_table('maasserver_macstaticipaddresslink')


    def backwards(self, orm):
        # Adding model 'MACStaticIPAddressLink'
        db.create_table('maasserver_macstaticipaddresslink', (
        ...
        db.send_create_signal('maasserver', ['MACStaticIPAddressLink'])

        # Adding unique constraint on 'MACStaticIPAddressLink', fields ['ip_address', 'mac_address']
        db.create_unique('maasserver_macstaticipaddresslink', ['ip_address_id', 'mac_address_id'])
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'1ae8a930-460f-11e5-91f4-80fa5b0c464e'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-1ae7b930-460f-11e5-91f4-80fa5b0c464e'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1439946639L'}),
