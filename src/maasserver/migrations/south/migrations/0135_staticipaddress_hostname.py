...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticIPAddress.hostname'
        db.add_column(u'maasserver_staticipaddress', 'hostname',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticIPAddress.hostname'
        db.delete_column(u'maasserver_staticipaddress', 'hostname')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'1a2ebaa0-d17c-11e4-9c68-000c294d2fd9'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-1a305b62-d17c-11e4-9c68-000c294d2fd9'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1427129166L'}),
