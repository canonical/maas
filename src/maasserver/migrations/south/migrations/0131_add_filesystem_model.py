...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'maasserver_filesystem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36)),
            ('fstype', self.gf('django.db.models.fields.CharField')(default=u'ext4', max_length=20)),
            ('partition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.Partition'], null=True, blank=True)),
            ('block_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.BlockDevice'], null=True, blank=True)),
            ('create_params', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('mount_point', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('mount_params', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'maasserver', ['Filesystem'])


    def backwards(self, orm):
        # Deleting model 'Filesystem'
        db.delete_table(u'maasserver_filesystem')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'1852ca76-c869-11e4-8be3-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-185228c8-c869-11e4-8be3-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1426131442L'}),
