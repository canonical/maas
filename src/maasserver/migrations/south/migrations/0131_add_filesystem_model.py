...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_filesystem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36)),
            ('fstype', self.gf('django.db.models.fields.CharField')(default='ext4', max_length=20)),
        ...
        db.send_create_signal('maasserver', ['Filesystem'])


    def backwards(self, orm):
        # Deleting model 'Filesystem'
        db.delete_table('maasserver_filesystem')
