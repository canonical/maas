...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_filesystemgroup', (
        ...
        db.send_create_signal('maasserver', ['FilesystemGroup'])

        # Adding field 'Filesystem.filesystem_group'
        db.add_column('maasserver_filesystem', 'filesystem_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='filesystems', null=True, to=orm['maasserver.FilesystemGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FilesystemGroup'
        db.delete_table('maasserver_filesystemgroup')

        # Deleting field 'Filesystem.filesystem_group'
        db.delete_column('maasserver_filesystem', 'filesystem_group_id')
