...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilesystemGroup'
        db.create_table(u'maasserver_filesystemgroup', (
        ...
        db.send_create_signal(u'maasserver', ['FilesystemGroup'])

        # Adding field 'Filesystem.filesystem_group'
        db.add_column(u'maasserver_filesystem', 'filesystem_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'filesystems', null=True, to=orm['maasserver.FilesystemGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FilesystemGroup'
        db.delete_table(u'maasserver_filesystemgroup')

        # Deleting field 'Filesystem.filesystem_group'
        db.delete_column(u'maasserver_filesystem', 'filesystem_group_id')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'f479d612-c8db-11e4-927c-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-f47a6dde-c8db-11e4-927c-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1426180774L'}),
