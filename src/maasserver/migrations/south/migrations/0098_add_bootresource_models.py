...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_bootresourceset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sets', to=orm['maasserver.BootResource'])),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('maasserver', ['BootResourceSet'])

        # Adding unique constraint on 'BootResourceSet', fields ['resource', 'version']
        db.create_unique('maasserver_bootresourceset', ['resource_id', 'version'])

        # Adding model 'BootResourceFile'
        db.create_table('maasserver_bootresourcefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('resource_set', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['maasserver.BootResourceSet'])),
            ('largefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.LargeFile'])),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('filetype', self.gf('django.db.models.fields.CharField')(default='tgz', max_length=20)),
            ('extra', self.gf('maasserver.fields.JSONObjectField')(default='', blank=True)),
        ))
        db.send_create_signal('maasserver', ['BootResourceFile'])

        # Adding unique constraint on 'BootResourceFile', fields ['resource_set', 'filetype']
        db.create_unique('maasserver_bootresourcefile', ['resource_set_id', 'filetype'])

        # Adding model 'BootResource'
        db.create_table('maasserver_bootresource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('maasserver', ['BootResource'])

        # Adding unique constraint on 'BootResource', fields ['rtype', 'name', 'architecture']
        db.create_unique('maasserver_bootresource', ['rtype', 'name', 'architecture'])


    def backwards(self, orm):
        # Removing unique constraint on 'BootResource', fields ['rtype', 'name', 'architecture']
        db.delete_unique('maasserver_bootresource', ['rtype', 'name', 'architecture'])

        # Removing unique constraint on 'BootResourceFile', fields ['resource_set', 'filetype']
        db.delete_unique('maasserver_bootresourcefile', ['resource_set_id', 'filetype'])

        # Removing unique constraint on 'BootResourceSet', fields ['resource', 'version']
        db.delete_unique('maasserver_bootresourceset', ['resource_id', 'version'])

        # Deleting model 'BootResourceSet'
        db.delete_table('maasserver_bootresourceset')

        # Deleting model 'BootResourceFile'
        db.delete_table('maasserver_bootresourcefile')

        # Deleting model 'BootResource'
        db.delete_table('maasserver_bootresource')
