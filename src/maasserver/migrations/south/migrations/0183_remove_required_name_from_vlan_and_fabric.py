...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'maasserver_fabric', ['name'])
        ...
        db.alter_column(u'maasserver_vlan', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Fabric.name'
        db.alter_column(u'maasserver_fabric', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_unique(u'maasserver_fabric', ['name'])
