...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Fabric', fields ['name']
        db.delete_unique('maasserver_fabric', ['name'])

        # Removing unique constraint on 'VLAN', fields ['name', 'fabric']
        db.delete_unique('maasserver_vlan', ['name', 'fabric_id'])


        # Changing field 'VLAN.name'
        db.alter_column('maasserver_vlan', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Fabric.name'
        db.alter_column('maasserver_fabric', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VLAN.name'
        raise RuntimeError("Cannot reverse this migration. 'VLAN.name' and its values cannot be restored.")
        # Adding unique constraint on 'VLAN', fields ['name', 'fabric']
        db.create_unique('maasserver_vlan', ['name', 'fabric_id'])


        # User chose to not deal with backwards NULL issues for 'Fabric.name'
        raise RuntimeError("Cannot reverse this migration. 'Fabric.name' and its values cannot be restored.")
        # Adding unique constraint on 'Fabric', fields ['name']
        db.create_unique('maasserver_fabric', ['name'])
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'a1d75a4c-6e44-11e5-a1dc-c48e8ffbb365'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-a1d55db4-6e44-11e5-a1dc-c48e8ffbb365'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1444367666L'}),
