...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_node', 'zone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.Zone'], on_delete=models.SET_DEFAULT))

    def backwards(self, orm):

        # Changing field 'Node.zone'
        db.alter_column('maasserver_node', 'zone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.Zone'], null=True))
