...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Because of bug lp:1485584 we need to remove the duplicate Interfaces
        # that get created by the old code in start_up.py. This start_up code
        # has been moved into the migration before this 0162.
        for mac in orm['maasserver.MACAddress'].objects.all():
            interfaces = list(mac.interface_set.all())
            if len(interfaces) > 1:
                # Delete all the other interfaces except the first one.
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'f6959402-44ed-11e5-92c5-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-f695ebdc-44ed-11e5-92c5-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1439822453L'}),
