...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(max_length=31))

    def backwards(self, orm):

        # Changing field 'Node.architecture'
        db.alter_column('maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-c99b0122-0980-11e2-aaba-525400f6f496'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1348845951L'}),
