...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # This will look for any architecture which has the hwe kernel
        # specified in the architecture and move the hwe kernel from the
        # architecture column to the min_hwe_kernel column. The subarchitecture
        # becomes 'generic'.
        # Example migrations:
        # amd64/generic  -> No change
        # amd64/hwe-t    -> amd64/generic, hwe-t
        # i386/hwe-q     -> i386/generic,  hwe-q
        # armfh/highbank -> No change
        db.execute(textwrap.dedent("""\
                   UPDATE maasserver_node
                       SET architecture = split_part(architecture, '/', 1) ||
                         '/generic',
                       min_hwe_kernel = split_part(architecture, '/', 2)
                   WHERE architecture ~ '.+/hwe-.+'
                   """))

    def backwards(self, orm):
        # If we need to go back to storing the hwe kernel in architecture this
        # will migrate the data back iff no subarchitecture is set and
        # min_hwe_kernel is set.
        # Example migrations:
        # amd64/generic,  null  -> No change
        # amd64/generic,  hwe-t -> amd64/hwe-t
        # i386/generic,   hwe-t -> i386/hwe-t
        # armfh/highbank, null  -> No change
        # armfh/highbank, hwe-t -> No change
        db.execute(textwrap.dedent("""\
                   UPDATE maasserver_node
                       SET architecture = split_part(architecture, '/', 1) ||
                         '/' || min_hwe_kernel
                    WHERE (min_hwe_kernel IS NOT NULL) AND
                      (trim(min_hwe_kernel) != '') AND
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'0967c4ae-3253-11e5-8972-10c37b9cd621'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-096d714c-3253-11e5-8972-10c37b9cd621'", 'unique': 'True', 'max_length': '41'}),
        ...
        'maasserver.partition': {
            'Meta': {'unique_together': "((u'partition_table', u'partition_number'),)", 'object_name': 'Partition'},
            'bootable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'partition_number': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1437776791L'}),
