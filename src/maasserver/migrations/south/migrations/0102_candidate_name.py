...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CandidateName'
        db.create_table(u'maasserver_candidatename', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'maasserver', ['CandidateName'])

        # Adding unique constraint on 'CandidateName', fields ['name', 'position']
        db.create_unique(u'maasserver_candidatename', ['name', 'position'])


    def backwards(self, orm):
        # Removing unique constraint on 'CandidateName', fields ['name', 'position']
        db.delete_unique(u'maasserver_candidatename', ['name', 'position'])

        # Deleting model 'CandidateName'
        db.delete_table(u'maasserver_candidatename')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'b6425614-2465-11e4-b54f-000c29a40c60'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-b64338f4-2465-11e4-b54f-000c29a40c60'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1408097999L'}),
