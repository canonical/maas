...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.storage'
        db.delete_column(u'maasserver_node', 'storage')


    def backwards(self, orm):
        # Adding field 'Node.storage'
        db.add_column(u'maasserver_node', 'storage',
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'832c5bf2-9b44-11e4-b737-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-832d2c26-9b44-11e4-b737-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1421167928L'}),
