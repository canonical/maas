...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_filestorage', 'content', self.gf('metadataserver.fields.BinaryField')(null=False))

    def backwards(self, orm):

        # Changing field 'FileStorage.content'
        db.alter_column('maasserver_filestorage', 'content', self.gf('metadataserver.fields.BinaryField')(null=True))
