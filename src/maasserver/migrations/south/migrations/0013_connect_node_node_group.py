...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'nodegroup', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['maasserver.NodeGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.nodegroup'
        db.delete_column('maasserver_node', 'nodegroup_id')
