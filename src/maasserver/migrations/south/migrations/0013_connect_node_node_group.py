...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.nodegroup'
        db.add_column(u'maasserver_node', 'nodegroup', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['maasserver.NodeGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.nodegroup'
        db.delete_column(u'maasserver_node', 'nodegroup_id')
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-bafb8226-cb6f-11e1-a7be-00248cfe5e24'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1342021652L'}),
