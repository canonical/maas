...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'maasserver_bootsourceselection', 'labels', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text'))

        # Changing field 'BootSourceSelection.arches'
        db.alter_column(u'maasserver_bootsourceselection', 'arches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text'))

        # Changing field 'BootSourceSelection.subarches'
        db.alter_column(u'maasserver_bootsourceselection', 'subarches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text'))
        # Deleting field 'Node.block_poweroff'
        db.delete_column(u'maasserver_node', 'block_poweroff')


        # Changing field 'Node.routers'
        db.alter_column(u'maasserver_node', 'routers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'macaddr'))

        # Changing field 'Subnet.dns_servers'
        db.alter_column(u'maasserver_subnet', 'dns_servers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text'))

        # Changing field 'BlockDevice.tags'
        db.alter_column(u'maasserver_blockdevice', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=False))

        # Changing field 'Interface.tags'
        db.alter_column(u'maasserver_interface', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=False))

    def backwards(self, orm):

        # Changing field 'BootSourceSelection.labels'
        db.alter_column(u'maasserver_bootsourceselection', 'labels', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=True))

        # Changing field 'BootSourceSelection.arches'
        db.alter_column(u'maasserver_bootsourceselection', 'arches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=True))

        # Changing field 'BootSourceSelection.subarches'
        db.alter_column(u'maasserver_bootsourceselection', 'subarches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=True))
        # Adding field 'Node.block_poweroff'
        db.add_column(u'maasserver_node', 'block_poweroff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Node.routers'
        db.alter_column(u'maasserver_node', 'routers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'macaddr', null=True))

        # Changing field 'Subnet.dns_servers'
        db.alter_column(u'maasserver_subnet', 'dns_servers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=True))

        # Changing field 'BlockDevice.tags'
        db.alter_column(u'maasserver_blockdevice', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text'))

        # Changing field 'Interface.tags'
        db.alter_column(u'maasserver_interface', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text'))
    ...
    models = {
        ...
        u'maasserver.blockdevice': {
            ...
            'tags': ('djorm_pgarray.fields.ArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'null': 'False', 'blank': 'True'}),
        ...
        u'maasserver.bootsourceselection': {
            ...
            'arches': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', u'dbtype': "u'text'", 'blank': 'True'}),
            'boot_source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['maasserver.BootSource']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'labels': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', u'dbtype': "u'text'", 'blank': 'True'}),
            ...
            'subarches': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', u'dbtype': "u'text'", 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {})
        },
        ...
        u'maasserver.node': {
            ...
            'routers': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', u'dbtype': "u'macaddr'", 'blank': 'True'}),
        ...
        u'maasserver.subnet': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'dns_servers': ('djorm_pgarray.fields.ArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
