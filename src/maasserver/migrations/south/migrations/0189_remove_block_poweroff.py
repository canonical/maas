...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BootSourceSelection.labels'
        db.alter_column('maasserver_bootsourceselection', 'labels', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text'))

        # Changing field 'BootSourceSelection.arches'
        db.alter_column('maasserver_bootsourceselection', 'arches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text'))

        # Changing field 'BootSourceSelection.subarches'
        db.alter_column('maasserver_bootsourceselection', 'subarches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text'))
        # Deleting field 'Node.block_poweroff'
        db.delete_column('maasserver_node', 'block_poweroff')


        # Changing field 'Node.routers'
        db.alter_column('maasserver_node', 'routers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='macaddr'))

        # Changing field 'Subnet.dns_servers'
        db.alter_column('maasserver_subnet', 'dns_servers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text'))

        # Changing field 'BlockDevice.tags'
        db.alter_column('maasserver_blockdevice', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text', null=False))

        # Changing field 'Interface.tags'
        db.alter_column('maasserver_interface', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text', null=False))

    def backwards(self, orm):

        # Changing field 'BootSourceSelection.labels'
        db.alter_column('maasserver_bootsourceselection', 'labels', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text', null=True))

        # Changing field 'BootSourceSelection.arches'
        db.alter_column('maasserver_bootsourceselection', 'arches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text', null=True))

        # Changing field 'BootSourceSelection.subarches'
        db.alter_column('maasserver_bootsourceselection', 'subarches', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text', null=True))
        # Adding field 'Node.block_poweroff'
        db.add_column('maasserver_node', 'block_poweroff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Node.routers'
        db.alter_column('maasserver_node', 'routers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='macaddr', null=True))

        # Changing field 'Subnet.dns_servers'
        db.alter_column('maasserver_subnet', 'dns_servers', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text', null=True))

        # Changing field 'BlockDevice.tags'
        db.alter_column('maasserver_blockdevice', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text'))

        # Changing field 'Interface.tags'
        db.alter_column('maasserver_interface', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype='text'))
    ...
    models = {
        ...
        'maasserver.blockdevice': {
            ...
            'tags': ('djorm_pgarray.fields.ArrayField', [], {'default': '[]', 'dbtype': "u'text'", 'null': 'False', 'blank': 'True'}),
        ...
        'maasserver.bootsourceselection': {
            ...
            'arches': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'text'", 'blank': 'True'}),
            'boot_source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.BootSource']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'labels': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'text'", 'blank': 'True'}),
            ...
            'subarches': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'text'", 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {})
        },
        'maasserver.cacheset': {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'b306a3d0-83be-11e5-bd0f-7c7a9140484f'", 'unique': 'True', 'max_length': '36'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'})
        },
        'maasserver.filesystem': {
            ...
            'cache_set': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'filesystems'", 'null': 'True', 'to': "orm['maasserver.CacheSet']"}),
        ...
        'maasserver.filesystemgroup': {
            ...
            'cache_set': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.CacheSet']", 'null': 'True', 'blank': 'True'}),
            'create_params': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'maasserver.interface': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_addresses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['maasserver.StaticIPAddress']", 'null': 'True', 'blank': 'True'}),
        ...
        'maasserver.node': {
            ...
            'boot_disk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['maasserver.PhysicalBlockDevice']", 'blank': 'True', 'null': 'True'}),
            'boot_interface': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['maasserver.Interface']", 'blank': 'True', 'null': 'True'}),
            ...
            'gateway_link_ipv4': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['maasserver.StaticIPAddress']", 'blank': 'True', 'null': 'True'}),
            'gateway_link_ipv6': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['maasserver.StaticIPAddress']", 'blank': 'True', 'null': 'True'}),
            ...
            'routers': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'macaddr'", 'blank': 'True'}),
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-b306a3d1-83be-11e5-bd0f-7c7a9140484f'", 'unique': 'True', 'max_length': '41'}),
        ...
        'maasserver.nodegroupinterface': {
            ...
            'subnet': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.Subnet']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
            'vlan': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.VLAN']", 'on_delete': 'models.PROTECT'})
        },
        ...
        'maasserver.staticipaddress': {
            ...
            'subnet': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.Subnet']", 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'})
        },
        'maasserver.subnet': {
            'Meta': {'unique_together': "((u'name', u'space'),)", 'object_name': 'Subnet'},
            'cidr': ('maasserver.fields.CIDRField', [], {'unique': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'dns_servers': ('djorm_pgarray.fields.ArrayField', [], {'default': '[]', 'dbtype': "u'text'", 'blank': 'True'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1446729077L'}),
