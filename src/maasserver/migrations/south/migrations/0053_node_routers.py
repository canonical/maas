...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'routers',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='macaddr', null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Node.routers'
        db.delete_column('maasserver_node', 'routers')
