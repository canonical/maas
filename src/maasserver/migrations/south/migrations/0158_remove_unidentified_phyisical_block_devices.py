...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Delete's all the `PhysicalBlockDevice`s that do not have the
        required information.

        This will cause the user to have to re-commission to gather the correct
        storage information.
        """
        for block_device in (
                orm['maasserver.PhysicalBlockDevice'].objects.all()):
            if (not block_device.model and
                    not block_device.serial and
                    not block_device.id_path):
                block_device.delete()
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'896e3e90-3c70-11e5-ba5e-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-896f7062-3c70-11e5-ba5e-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1438888974L'}),
