...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_licensekey', (
        ...
        db.send_create_signal('maasserver', ['LicenseKey'])

        # Adding unique constraint on 'LicenseKey', fields ['osystem', 'distro_series']
        db.create_unique('maasserver_licensekey', ['osystem', 'distro_series'])


    def backwards(self, orm):
        # Removing unique constraint on 'LicenseKey', fields ['osystem', 'distro_series']
        db.delete_unique('maasserver_licensekey', ['osystem', 'distro_series'])

        # Deleting model 'LicenseKey'
        db.delete_table('maasserver_licensekey')
