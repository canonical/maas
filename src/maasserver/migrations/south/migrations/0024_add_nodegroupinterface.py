...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_nodegroupinterface', (
            ...
            ('interface', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
        ...
        db.send_create_signal('maasserver', ['NodeGroupInterface'])

        # Adding unique constraint on 'NodeGroupInterface', fields ['nodegroup', 'interface']
        db.create_unique('maasserver_nodegroupinterface', ['nodegroup_id', 'interface'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'NodeGroupInterface', fields ['nodegroup', 'interface']
        db.delete_unique('maasserver_nodegroupinterface', ['nodegroup_id', 'interface'])

        # Deleting model 'NodeGroupInterface'
        db.delete_table('maasserver_nodegroupinterface')
