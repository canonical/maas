...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_virtualblockdevice', (
            ...
            ('filesystem_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='virtual_devices', to=orm['maasserver.FilesystemGroup'])),
        ))
        db.send_create_signal('maasserver', ['VirtualBlockDevice'])


    def backwards(self, orm):
        # Deleting model 'VirtualBlockDevice'
        db.delete_table('maasserver_virtualblockdevice')
