...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maasserver_bootimage', 'label',
                      self.gf('django.db.models.fields.CharField')(default=u'release', max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'maasserver_bootimage', 'label')
