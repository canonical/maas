...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('maasserver_node_networks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('node', models.ForeignKey(orm['maasserver.node'], null=False)),
            ('network', models.ForeignKey(orm['maasserver.network'], null=False))
        ))
        db.create_unique('maasserver_node_networks', ['node_id', 'network_id'])
