...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field networks on 'Node'
        db.delete_table('maasserver_node_networks')


    def backwards(self, orm):
        # Adding M2M table for field networks on 'Node'
        db.create_table(u'maasserver_node_networks', (
        ...
        db.create_unique(u'maasserver_node_networks', ['node_id', 'network_id'])
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'5ba0348e-9a26-11e3-8c88-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-5b9edd46-9a26-11e3-8c88-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1392897528L'}),
