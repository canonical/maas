...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BootSource.cluster'
        db.delete_column(u'maasserver_bootsource', 'cluster_id')


    def backwards(self, orm):
        # Adding field 'BootSource.cluster'
        db.add_column(u'maasserver_bootsource', 'cluster',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.NodeGroup'], null=True),
                      keep_default=False)
