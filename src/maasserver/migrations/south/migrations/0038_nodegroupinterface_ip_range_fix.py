...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'NodeGroupInterface', fields ['ip_range_low']
        db.delete_unique('maasserver_nodegroupinterface', ['ip_range_low'])

        # Removing unique constraint on 'NodeGroupInterface', fields ['ip_range_high']
        db.delete_unique('maasserver_nodegroupinterface', ['ip_range_high'])


    def backwards(self, orm):
        # Adding unique constraint on 'NodeGroupInterface', fields ['ip_range_high']
        db.create_unique('maasserver_nodegroupinterface', ['ip_range_high'])

        # Adding unique constraint on 'NodeGroupInterface', fields ['ip_range_low']
        db.create_unique('maasserver_nodegroupinterface', ['ip_range_low'])
    ...
    models = {
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-fd4b6478-0c9e-11e2-a906-3c970e0e56dc'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1349188776L'}),
