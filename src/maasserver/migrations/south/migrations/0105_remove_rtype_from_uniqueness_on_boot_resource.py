...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('maasserver_bootresource', ['architecture', 'name', 'rtype'])

        # Adding unique constraint on 'BootResource', fields ['name', 'architecture']
        db.create_unique('maasserver_bootresource', ['name', 'architecture'])


    def backwards(self, orm):
        # Removing unique constraint on 'BootResource', fields ['name', 'architecture']
        db.delete_unique('maasserver_bootresource', ['name', 'architecture'])

        # Adding unique constraint on 'BootResource', fields ['architecture', 'name', 'rtype']
        db.create_unique('maasserver_bootresource', ['architecture', 'name', 'rtype'])
