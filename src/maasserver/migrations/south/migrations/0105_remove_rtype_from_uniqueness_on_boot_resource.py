...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BootResource', fields ['architecture', 'name', 'rtype']
        db.delete_unique(u'maasserver_bootresource', ['architecture', 'name', 'rtype'])

        # Adding unique constraint on 'BootResource', fields ['name', 'architecture']
        db.create_unique(u'maasserver_bootresource', ['name', 'architecture'])


    def backwards(self, orm):
        # Removing unique constraint on 'BootResource', fields ['name', 'architecture']
        db.delete_unique(u'maasserver_bootresource', ['name', 'architecture'])

        # Adding unique constraint on 'BootResource', fields ['architecture', 'name', 'rtype']
        db.create_unique(u'maasserver_bootresource', ['architecture', 'name', 'rtype'])
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'8cc62392-2a28-11e4-8988-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-8cc3fc5c-2a28-11e4-8988-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1408731437L'}),
