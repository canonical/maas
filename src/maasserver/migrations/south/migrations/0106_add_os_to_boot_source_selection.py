...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_bootsourceselection', 'os',
                      self.gf('django.db.models.fields.CharField')(default='ubuntu', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BootSourceSelection.os'
        db.delete_column('maasserver_bootsourceselection', 'os')
