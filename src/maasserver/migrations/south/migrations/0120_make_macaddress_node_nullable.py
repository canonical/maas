...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'MACAddress.node'
        db.alter_column('maasserver_macaddress', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.Node'], null=True))

    def backwards(self, orm):
        # Changing field 'MACAddress.node'
        db.alter_column('maasserver_macaddress', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['maasserver.Node']))
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'faedd62a-65f2-11e4-a330-000c29e3e0e3'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-faec7be0-65f2-11e4-a330-000c29e3e0e3'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1415305477L'}),
