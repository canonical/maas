...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_staticipaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('maasserver', ['StaticIPAddress'])

        # Adding field 'NodeGroupInterface.static_ip_range_low'
        db.add_column('maasserver_nodegroupinterface', 'static_ip_range_low',
                      self.gf('django.db.models.fields.GenericIPAddressField')(default=None, max_length=39, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NodeGroupInterface.static_ip_range_high'
        db.add_column('maasserver_nodegroupinterface', 'static_ip_range_high',
                      self.gf('django.db.models.fields.GenericIPAddressField')(default=None, max_length=39, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('maasserver_staticipaddress')

        # Deleting field 'NodeGroupInterface.static_ip_range_low'
        db.delete_column('maasserver_nodegroupinterface', 'static_ip_range_low')

        # Deleting field 'NodeGroupInterface.static_ip_range_high'
        db.delete_column('maasserver_nodegroupinterface', 'static_ip_range_high')
