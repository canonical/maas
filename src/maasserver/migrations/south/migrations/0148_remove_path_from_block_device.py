...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('maasserver_blockdevice', ['node_id', 'path'])

        # Deleting field 'BlockDevice.path'
        db.delete_column('maasserver_blockdevice', 'path')

        # Adding unique constraint on 'BlockDevice', fields ['node', 'name']
        db.create_unique('maasserver_blockdevice', ['node_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'BlockDevice', fields ['node', 'name']
        db.delete_unique('maasserver_blockdevice', ['node_id', 'name'])

        # blake_r - I don't really like this but since path has NOT NULL, and
        # unique we just can't set it to a default value.
        raise RuntimeError(
            "Cannot reverse this migration. 'BlockDevice.path' and its values "
            "cannot be restored.")
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'dfe1a812-1f73-11e5-9405-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-dfdfe702-1f73-11e5-9405-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1435701821L'}),
