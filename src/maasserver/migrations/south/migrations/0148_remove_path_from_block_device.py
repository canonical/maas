...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'maasserver_blockdevice', 'path')

        # Adding unique constraint on 'BlockDevice', fields ['node', 'name']
        db.create_unique(u'maasserver_blockdevice', ['node_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'BlockDevice', fields ['node', 'name']
        db.delete_unique(u'maasserver_blockdevice', ['node_id', 'name'])
