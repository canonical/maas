...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'pxe_mac',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['maasserver.MACAddress']),
                      keep_default=False)
    ...
    models = {
        ...
        'maasserver.node': {
            ...
            'pxe_mac': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'+'", 'null': 'True', 'to': "orm['maasserver.MACAddress']"}),
