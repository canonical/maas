...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maasserver_blockdevice', (
        ...
        db.send_create_signal('maasserver', ['BlockDevice'])

        # Adding unique constraint on 'BlockDevice', fields ['node', 'path']
        db.create_unique('maasserver_blockdevice', ['node_id', 'path'])

        # Adding model 'PhysicalBlockDevice'
        db.create_table('maasserver_physicalblockdevice', (
            ('blockdevice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['maasserver.BlockDevice'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('maasserver', ['PhysicalBlockDevice'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('maasserver_blockdevice')

        # Deleting model 'PhysicalBlockDevice'
        db.delete_table('maasserver_physicalblockdevice')
    ...
    models = {
        ...
        'maasserver.physicalblockdevice': {
            'Meta': {'object_name': 'PhysicalBlockDevice', '_ormbases': ['maasserver.BlockDevice']},
