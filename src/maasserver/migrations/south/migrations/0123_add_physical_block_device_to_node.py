...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlockDevice'
        db.create_table(u'maasserver_blockdevice', (
            ...
            ('block_size', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'maasserver', ['BlockDevice'])

        # Adding unique constraint on 'BlockDevice', fields ['node', 'path']
        db.create_unique(u'maasserver_blockdevice', ['node_id', 'path'])

        # Adding model 'PhysicalBlockDevice'
        db.create_table(u'maasserver_physicalblockdevice', (
            (u'blockdevice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['maasserver.BlockDevice'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'maasserver', ['PhysicalBlockDevice'])


    def backwards(self, orm):
        # Removing unique constraint on 'BlockDevice', fields ['node', 'path']
        db.delete_unique(u'maasserver_blockdevice', ['node_id', 'path'])

        # Deleting model 'BlockDevice'
        db.delete_table(u'maasserver_blockdevice')

        # Deleting model 'PhysicalBlockDevice'
        db.delete_table(u'maasserver_physicalblockdevice')
    ...
    models = {
        ...
        u'maasserver.blockdevice': {
            'Meta': {'unique_together': "((u'node', u'path'),)", 'object_name': 'BlockDevice'},
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'ac625ca2-94f4-11e4-a4e3-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-ac61a14a-94f4-11e4-a4e3-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'maasserver.physicalblockdevice': {
            'Meta': {'object_name': 'PhysicalBlockDevice', '_ormbases': [u'maasserver.BlockDevice']},
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1420473930L'}),
