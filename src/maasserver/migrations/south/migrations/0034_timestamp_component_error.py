...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('maasserver_componenterror', 'created')

        # Deleting field 'ComponentError.updated'
        db.delete_column('maasserver_componenterror', 'updated')
