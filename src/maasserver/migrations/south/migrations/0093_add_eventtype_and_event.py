...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table('maasserver_event', (
        ...
        db.send_create_signal('maasserver', ['Event'])

        # Adding model 'EventType'
        db.create_table('maasserver_eventtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('maasserver', ['EventType'])


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table('maasserver_event')

        # Deleting model 'EventType'
        db.delete_table('maasserver_eventtype')
