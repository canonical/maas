...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'maasserver_cacheset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'maasserver', ['CacheSet'])

        # Adding field 'Filesystem.cache_set'
        db.add_column(u'maasserver_filesystem', 'cache_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'filesystems', null=True, to=orm['maasserver.CacheSet']),
                      keep_default=False)

        # Adding field 'FilesystemGroup.cache_set'
        db.add_column(u'maasserver_filesystemgroup', 'cache_set',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'maasserver_cacheset')

        # Deleting field 'Filesystem.cache_set'
        db.delete_column(u'maasserver_filesystem', 'cache_set_id')

        # Deleting field 'FilesystemGroup.cache_set'
        db.delete_column(u'maasserver_filesystemgroup', 'cache_set_id')
