...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CacheSet'
        db.create_table('maasserver_cacheset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('maasserver', ['CacheSet'])

        # Adding field 'Filesystem.cache_set'
        db.add_column('maasserver_filesystem', 'cache_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='filesystems', null=True, to=orm['maasserver.CacheSet']),
                      keep_default=False)

        # Adding field 'FilesystemGroup.cache_set'
        db.add_column('maasserver_filesystemgroup', 'cache_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.CacheSet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CacheSet'
        db.delete_table('maasserver_cacheset')

        # Deleting field 'Filesystem.cache_set'
        db.delete_column('maasserver_filesystem', 'cache_set_id')

        # Deleting field 'FilesystemGroup.cache_set'
        db.delete_column('maasserver_filesystemgroup', 'cache_set_id')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'd00ad778-40cb-11e5-b68d-7c7a91916829'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-d00c93d8-40cb-11e5-b68d-7c7a91916829'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1439367981L'}),
