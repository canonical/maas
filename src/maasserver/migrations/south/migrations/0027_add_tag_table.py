...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tag'
        db.create_table('maasserver_tag', (
        ...
        db.send_create_signal('maasserver', ['Tag'])

        # Adding M2M table for field tags on 'Node'
        db.create_table('maasserver_node_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('node', models.ForeignKey(orm['maasserver.node'], null=False)),
            ('tag', models.ForeignKey(orm['maasserver.tag'], null=False))
        ))
        db.create_unique('maasserver_node_tags', ['node_id', 'tag_id'])


    def backwards(self, orm):
        
        # Deleting model 'Tag'
        db.delete_table('maasserver_tag')
