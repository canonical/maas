...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('maasserver_network', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Network.description'
        db.alter_column('maasserver_network', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
