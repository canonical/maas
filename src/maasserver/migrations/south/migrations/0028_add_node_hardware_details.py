...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_node', 'cpu_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Node.memory'
        db.add_column('maasserver_node', 'memory', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Node.hardware_details'
        db.add_column('maasserver_node', 'hardware_details', self.gf('maasserver.fields.XMLField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Node.cpu_count'
        db.delete_column('maasserver_node', 'cpu_count')

        # Deleting field 'Node.memory'
        db.delete_column('maasserver_node', 'memory')

        # Deleting field 'Node.hardware_details'
        db.delete_column('maasserver_node', 'hardware_details')
