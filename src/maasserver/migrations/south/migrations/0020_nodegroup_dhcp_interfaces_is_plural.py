...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'NodeGroup.dhcp_interface' to
        # 'NodeGroup.dhcp_interfaces'.
        db.rename_column(
            u'maasserver_nodegroup', 'dhcp_interface', 'dhcp_interfaces')

    def backwards(self, orm):
        
        # Renaming field 'NodeGroup.dhcp_interfaces' back to
        # 'NodeGroup.dhcp_interface'.
        db.rename_column(
            u'maasserver_nodegroup', 'dhcp_interfaces', 'dhcp_interface')
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-3458c900-f63e-11e1-a676-002608dc6120'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1346728280L'}),
