...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maasserver_nodegroup', 'dhcp_interface', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NodeGroup.dhcp_interface'
        db.delete_column('maasserver_nodegroup', 'dhcp_interface')
