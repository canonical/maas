...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Partition', fields ['partition_table', 'partition_number']
        db.delete_unique('maasserver_partition', ['partition_table_id', 'partition_number'])

        # Deleting field 'Partition.start_offset'
        db.delete_column('maasserver_partition', 'start_offset')

        # Deleting field 'Partition.partition_number'
        db.delete_column('maasserver_partition', 'partition_number')


    def backwards(self, orm):
        # Adding field 'Partition.start_offset'
        db.add_column('maasserver_partition', 'start_offset',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Partition.partition_number'
        db.add_column('maasserver_partition', 'partition_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Partition', fields ['partition_table', 'partition_number']
        db.create_unique('maasserver_partition', ['partition_table_id', 'partition_number'])
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'6b5e9b64-3489-11e5-911e-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-6b5dfed4-3489-11e5-911e-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1438020043L'}),
