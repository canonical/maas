...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FanNetwork'
        db.create_table('maasserver_fannetwork', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('overlay', self.gf('maasserver.fields.IPv4CIDRField')(unique=True)),
            ('underlay', self.gf('maasserver.fields.IPv4CIDRField')(unique=True)),
            ('dhcp', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('host_reserve', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('bridge', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('off', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
        ))
        db.send_create_signal('maasserver', ['FanNetwork'])


    def backwards(self, orm):
        # Deleting model 'FanNetwork'
        db.delete_table('maasserver_fannetwork')
    ...
    models = {
        ...
        'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'584c4436-609e-11e5-be67-00163e7b2746'", 'unique': 'True', 'max_length': '36'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'maasserver.filesystem': {
            'Meta': {'object_name': 'Filesystem'},
            'block_device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.BlockDevice']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'partition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maasserver.Partition']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-584b55d0-609e-11e5-be67-00163e7b2746'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1442866889L'}),
