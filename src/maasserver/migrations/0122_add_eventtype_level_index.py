...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EventType', fields ['level']
        db.create_index(u'maasserver_eventtype', ['level'])


    def backwards(self, orm):
        # Removing index on 'EventType', fields ['level']
        db.delete_index(u'maasserver_eventtype', ['level'])
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'dad07d4a-8792-11e4-a944-000c29e3e0e3'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-dace16f4-8792-11e4-a944-000c29e3e0e3'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1419002552L'}),
