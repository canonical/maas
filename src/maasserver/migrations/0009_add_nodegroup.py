...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'maasserver_nodegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('name', self.gf('django.db.models.fields.CharField')(default=u'', unique=True, max_length=80)),
            ('api_token', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['piston.Token'], unique=True)),
            ('api_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=18)),
            ('worker_ip', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15)),
            ('subnet_mask', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('broadcast_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('router_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('ip_range_low', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15)),
            ('ip_range_high', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15)),
        ))
        db.send_create_signal(u'maasserver', ['NodeGroup'])


    def backwards(self, orm):
        
        # Deleting model 'NodeGroup'
        db.delete_table(u'maasserver_nodegroup')
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-e3dbb694-aed1-11e1-84fa-002215205ce8'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1338875229L'}),
