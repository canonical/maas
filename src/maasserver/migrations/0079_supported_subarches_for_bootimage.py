...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BootImage.supported_subarches'
        db.add_column(u'maasserver_bootimage', 'supported_subarches',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BootImage.supported_subarches'
        db.delete_column(u'maasserver_bootimage', 'supported_subarches')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'bcd25748-dbd3-11e3-92fe-002215205ce8'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-bcd574b4-dbd3-11e3-92fe-002215205ce8'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1400118819L'}),
