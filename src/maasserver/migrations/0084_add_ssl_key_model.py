...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SSLKey'
        db.create_table(u'maasserver_sslkey', (
        ...
        db.send_create_signal(u'maasserver', ['SSLKey'])

        # Adding unique constraint on 'SSLKey', fields ['user', 'key']
        db.create_unique(u'maasserver_sslkey', ['user_id', 'key'])


    def backwards(self, orm):
        # Removing unique constraint on 'SSLKey', fields ['user', 'key']
        db.delete_unique(u'maasserver_sslkey', ['user_id', 'key'])

        # Deleting model 'SSLKey'
        db.delete_table(u'maasserver_sslkey')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'16092ece-f63f-11e3-9d03-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-160880dc-f63f-11e3-9d03-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1403023656L'}),
