...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Event', fields ['node', u'id']
        db.create_index(u'maasserver_event', ['node_id', u'id'])


    def backwards(self, orm):
        # Removing index on 'Event', fields ['node', u'id']
        db.delete_index(u'maasserver_event', ['node_id', u'id'])
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'ca7f9ec6-0e7e-11e5-8f3a-3c970e0e56dc'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-ca8290ae-0e7e-11e5-8f3a-3c970e0e56dc'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1433837342L'}),
