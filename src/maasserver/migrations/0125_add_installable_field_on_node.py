...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.installable'
        db.add_column(u'maasserver_node', 'installable',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


        # Changing field 'Node.architecture'
        db.alter_column(u'maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(max_length=31, null=True))

    def backwards(self, orm):
        # Deleting field 'Node.installable'
        db.delete_column(u'maasserver_node', 'installable')


        # Changing field 'Node.architecture'
        db.alter_column(u'maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(default='', max_length=31))
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'4c8a047a-9a3e-11e4-9542-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-4c876530-9a3e-11e4-9542-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1421055305L'}),
