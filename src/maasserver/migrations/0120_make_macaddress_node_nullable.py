...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'maasserver_macaddress', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.Node'], null=True))

    def backwards(self, orm):
        # Changing field 'MACAddress.node'
        db.alter_column(u'maasserver_macaddress', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['maasserver.Node']))
