...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'maasserver_partition', ['partition_table_id', 'partition_number'])

        # Deleting field 'Partition.start_offset'
        db.delete_column(u'maasserver_partition', 'start_offset')

        # Deleting field 'Partition.partition_number'
        db.delete_column(u'maasserver_partition', 'partition_number')


    def backwards(self, orm):
        # Adding field 'Partition.start_offset'
        db.add_column(u'maasserver_partition', 'start_offset',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Partition.partition_number'
        db.add_column(u'maasserver_partition', 'partition_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Partition', fields ['partition_table', 'partition_number']
        db.create_unique(u'maasserver_partition', ['partition_table_id', 'partition_number'])
