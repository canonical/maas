...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VirtualBlockDevice'
        db.create_table(u'maasserver_virtualblockdevice', (
            ...
            ('filesystem_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'virtual_devices', to=orm['maasserver.FilesystemGroup'])),
        ))
        db.send_create_signal(u'maasserver', ['VirtualBlockDevice'])


    def backwards(self, orm):
        # Deleting model 'VirtualBlockDevice'
        db.delete_table(u'maasserver_virtualblockdevice')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'4d920d68-c8dd-11e4-ae96-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-4d9172d6-c8dd-11e4-ae96-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1426181353L'}),
