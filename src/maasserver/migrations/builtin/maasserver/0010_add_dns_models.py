...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('maasserver', '0009_remove_routers_field_from_node'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(editable=False)),
                ('updated', models.DateTimeField(editable=False)),
                ('name', maasserver.fields.DomainNameField(unique=True, max_length=256)),
                ('authoritative', models.NullBooleanField(default=True, db_index=True)),
            ],
            options={
                'verbose_name': 'Domain',
        ...
        migrations.AddField(
            model_name='dnsresource',
            name='ip_addresses',
            field=models.ManyToManyField(blank=True, to='maasserver.StaticIPAddress'),
        ),
        migrations.AddField(
            model_name='node',
            name='domain',
            field=models.ForeignKey(default=None, null=True, to='maasserver.Domain', on_delete=django.db.models.deletion.PROTECT),
        ),
    ]
