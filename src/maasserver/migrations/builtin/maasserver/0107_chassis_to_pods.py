...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('maasserver', '0106_testing_status'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bmc',
            name='architectures',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), size=None, null=True, default=list, blank=True),
        ),
        migrations.AddField(
            model_name='bmc',
            name='bmc_type',
            field=models.IntegerField(editable=False, choices=[(0, 'BMC'), (1, 'POD')], default=0),
        ),
        migrations.AddField(
            model_name='bmc',
            name='capabilities',
