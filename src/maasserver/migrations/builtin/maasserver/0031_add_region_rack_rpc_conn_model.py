    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endpoint', models.ForeignKey(related_name='connections', to='maasserver.RegionControllerProcessEndpoint', on_delete=models.CASCADE)),
                ('rack_controller', models.ForeignKey(related_name='connections', to='maasserver.RackController', on_delete=models.CASCADE)),
            ],
