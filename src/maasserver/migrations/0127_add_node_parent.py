...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'maasserver_node', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'children', null=True, blank=True, to=orm['maasserver.Node']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.parent'
        db.delete_column(u'maasserver_node', 'parent_id')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'0943573a-a217-11e4-9cf9-3c970e0e56dc'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-0940fda0-a217-11e4-9cf9-3c970e0e56dc'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1421918054L'}),
