...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.power_state_updated'
        db.add_column(u'maasserver_node', 'power_state_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


        # Changing field 'Node.power_parameters'
        db.alter_column(u'maasserver_node', 'power_parameters', self.gf('maasserver.fields.JSONObjectField')(max_length=32768))

    def backwards(self, orm):
        # Deleting field 'Node.power_state_updated'
        db.delete_column(u'maasserver_node', 'power_state_updated')


        # Changing field 'Node.power_parameters'
        db.alter_column(u'maasserver_node', 'power_parameters', self.gf('maasserver.fields.JSONObjectField')())
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'083eacb2-24a9-11e5-b81e-00163edfc3e6'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-083c99ea-24a9-11e5-b81e-00163edfc3e6'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1436274410L'}),
