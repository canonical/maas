...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BootSourceSelection'
        db.create_table(u'maasserver_bootsourceselection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('boot_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.BootSource'])),
            ('release', self.gf('django.db.models.fields.CharField')(default=u'', max_length=20, null=True, blank=True)),
            ('arches', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype=u'text', null=True, blank=True)),
            ('subarches', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype=u'text', null=True, blank=True)),
            ('labels', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype=u'text', null=True, blank=True)),
        ))
        db.send_create_signal(u'maasserver', ['BootSourceSelection'])

        # Adding model 'BootSource'
        db.create_table(u'maasserver_bootsource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.NodeGroup'], null=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('keyring_filename', self.gf('django.db.models.fields.FilePathField')(max_length=100, blank=True)),
            ('keyring_data', self.gf('django.db.models.fields.BinaryField')(blank=True)),
        ))
        db.send_create_signal(u'maasserver', ['BootSource'])


    def backwards(self, orm):
        # Deleting model 'BootSourceSelection'
        db.delete_table(u'maasserver_bootsourceselection')

        # Deleting model 'BootSource'
        db.delete_table(u'maasserver_bootsource')
    ...
    models = {
        ...
        u'maasserver.bootimage': {
            'Meta': {'unique_together': "((u'nodegroup', u'architecture', u'subarchitecture', u'release', u'purpose', u'label'),)", 'object_name': 'BootImage'},
        ...
        u'maasserver.bootsource': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyring_data': ('django.db.models.fields.BinaryField', [], {'blank': 'True'}),
        ...
        u'maasserver.bootsourceselection': {
            ...
            'release': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'951de876-d088-11e3-bca1-000c29e3e0e3'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-951f2254-d088-11e3-bca1-000c29e3e0e3'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1398877078L'}),
