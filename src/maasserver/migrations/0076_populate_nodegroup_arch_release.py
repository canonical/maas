...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Populate the nodegroups' architecture and release fields."""
        for nodegroup in orm['maasserver.NodeGroup'].objects.all():
            bootimages = orm['maasserver.BootImage'].objects.filter(nodegroup=nodegroup)
            arches_subarches = bootimages.values_list('architecture', 'subarchitecture')
            architectures = set(["%s/%s" % (arch, subarch) for arch, subarch in arches_subarches])
            releases = set(bootimages.values_list('release', flat=True))
            nodegroup.architectures = sorted(architectures)
            nodegroup.releases = sorted(releases)
            nodegroup.save()
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'04b137e0-aa7f-11e3-a403-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-04b4450c-aa7f-11e3-a403-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1394694826L'}),
