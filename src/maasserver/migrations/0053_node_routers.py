...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.routers'
        db.add_column(u'maasserver_node', 'routers',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype=u'macaddr', null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Node.routers'
        db.delete_column(u'maasserver_node', 'routers')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'279d8c52-09ff-11e3-90d1-94de80b61466'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-279e1c3a-09ff-11e3-90d1-94de80b61466'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1377047723L'}),
