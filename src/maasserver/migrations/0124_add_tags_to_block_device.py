...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlockDevice.tags'
        db.add_column(u'maasserver_blockdevice', 'tags',
                      self.gf('djorm_pgarray.fields.ArrayField')(default='{}', dbtype=u'text', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlockDevice.tags'
        db.delete_column(u'maasserver_blockdevice', 'tags')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'08f5bc1a-976c-11e4-bc4a-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-08f4e970-976c-11e4-bc4a-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1420745098L'}),
