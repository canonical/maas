...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BootResourceSet'
        db.create_table(u'maasserver_bootresourceset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sets', to=orm['maasserver.BootResource'])),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'maasserver', ['BootResourceSet'])

        # Adding unique constraint on 'BootResourceSet', fields ['resource', 'version']
        db.create_unique(u'maasserver_bootresourceset', ['resource_id', 'version'])

        # Adding model 'BootResourceFile'
        db.create_table(u'maasserver_bootresourcefile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('resource_set', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'files', to=orm['maasserver.BootResourceSet'])),
            ('largefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maasserver.LargeFile'])),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('filetype', self.gf('django.db.models.fields.CharField')(default=u'tgz', max_length=20)),
            ('extra', self.gf('maasserver.fields.JSONObjectField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'maasserver', ['BootResourceFile'])

        # Adding unique constraint on 'BootResourceFile', fields ['resource_set', 'filetype']
        db.create_unique(u'maasserver_bootresourcefile', ['resource_set_id', 'filetype'])

        # Adding model 'BootResource'
        db.create_table(u'maasserver_bootresource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('rtype', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('architecture', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('extra', self.gf('maasserver.fields.JSONObjectField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'maasserver', ['BootResource'])

        # Adding unique constraint on 'BootResource', fields ['rtype', 'name', 'architecture']
        db.create_unique(u'maasserver_bootresource', ['rtype', 'name', 'architecture'])


    def backwards(self, orm):
        # Removing unique constraint on 'BootResource', fields ['rtype', 'name', 'architecture']
        db.delete_unique(u'maasserver_bootresource', ['rtype', 'name', 'architecture'])

        # Removing unique constraint on 'BootResourceFile', fields ['resource_set', 'filetype']
        db.delete_unique(u'maasserver_bootresourcefile', ['resource_set_id', 'filetype'])

        # Removing unique constraint on 'BootResourceSet', fields ['resource', 'version']
        db.delete_unique(u'maasserver_bootresourceset', ['resource_id', 'version'])

        # Deleting model 'BootResourceSet'
        db.delete_table(u'maasserver_bootresourceset')

        # Deleting model 'BootResourceFile'
        db.delete_table(u'maasserver_bootresourcefile')

        # Deleting model 'BootResource'
        db.delete_table(u'maasserver_bootresource')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'6cbc940e-1fd4-11e4-bd35-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-6cbbcbe6-1fd4-11e4-bd35-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1407595794L'}),
