...
class _NODEGROUP_STATUS:
    """Redefine the NODEGROUP_STATUS enum here, because we'll be removing
    the PENDING status."""
    #: A nodegroup starts out as ``ENABLED``.
    DEFAULT = 1

    #: The nodegroup has been created and awaits approval.
    #: This status is deprecated and will be removed.
    PENDING = 0
    #:
    ENABLED = 1
    #:
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for nodegroup in orm.Nodegroup.objects.filter(
                status=_NODEGROUP_STATUS.PENDING):
            nodegroup.status = _NODEGROUP_STATUS.DISABLED
            nodegroup.save()
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'ce6bfd86-fd80-11e4-b91f-80fa5b08ed9b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-ce6c8bca-fd80-11e4-b91f-80fa5b08ed9b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1431969038L'}),
