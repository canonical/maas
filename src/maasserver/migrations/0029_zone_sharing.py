...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'NodeGroup', fields ['name']
        db.delete_unique(u'maasserver_nodegroup', ['name'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'NodeGroup', fields ['name']
        db.create_unique(u'maasserver_nodegroup', ['name'])
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-290d6f68-08a6-11e2-8f3c-001fc672380e'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1348752051L'}),
