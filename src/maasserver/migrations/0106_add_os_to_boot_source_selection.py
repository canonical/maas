...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BootSourceSelection.os'
        db.add_column(u'maasserver_bootsourceselection', 'os',
                      self.gf('django.db.models.fields.CharField')(default=u'ubuntu', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BootSourceSelection.os'
        db.delete_column(u'maasserver_bootsourceselection', 'os')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'd8f4cea4-2b8f-11e4-ba39-bcee7b78dc5b'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-d8f373d8-2b8f-11e4-ba39-bcee7b78dc5b'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1408885754L'}),
