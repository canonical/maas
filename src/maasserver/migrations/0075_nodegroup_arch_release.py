...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeGroup.architectures'
        db.add_column(u'maasserver_nodegroup', 'architectures',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype=u'text', null=True, blank=True),
                      keep_default=False)

        # Adding field 'NodeGroup.releases'
        db.add_column(u'maasserver_nodegroup', 'releases',
                      self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype=u'text', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeGroup.architectures'
        db.delete_column(u'maasserver_nodegroup', 'architectures')

        # Deleting field 'NodeGroup.releases'
        db.delete_column(u'maasserver_nodegroup', 'releases')
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'91d611e8-aa7c-11e3-8de1-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-91d74108-aa7c-11e3-8de1-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'maasserver.nodegroup': {
            ...
            'architectures': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'text'", 'null': 'True', 'blank': 'True'}),
            ...
            'releases': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'text'", 'null': 'True', 'blank': 'True'}),
            'simplestreams_filter': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1394693774L'}),
