# -*- coding: utf-8 -*-
from provisioningserver.import_images.ephemerals_script import compose_filter
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Populate the nodegroups' simplestreams_filter fields."""
        for nodegroup in orm['maasserver.NodeGroup'].objects.filter(simplestreams_filter=''):
            ...
            arches = set(["%s/%s" % (arch, subarch) for arch, subarch in arches_subarches])
            releases = set(bootimages.values_list('release', flat=True))
            sstream_filters = [
                compose_filter('arch', arches),
                compose_filter('release', releases),
            ]
            nodegroup.simplestreams_filter = ' '.join(sstream_filters)
            nodegroup.save()
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'b4a73dcc-a9bf-11e3-bb2d-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-b4a3da42-a9bf-11e3-bb2d-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1394612658L'}),
