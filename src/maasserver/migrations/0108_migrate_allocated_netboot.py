...
# Hardcode the values of the statuses instead of using the enum
# module to avoid breakable if the meaning of the values changes
# later.
allocated_status = 6
deployed_status = 10
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Before the changes introduced by the robustness feature, allocated was
        # conflating 3 states: allocated, deploying and deployed.  Now the distinction
        # is made explicit by having 3 different states.
        #
        # This migration moves allocated nodes with netboot off to 'Deployed'.
        deployed_nodes = orm['maasserver.Node'].objects.filter(netboot=False, status=allocated_status)
        deployed_nodes.update(status=deployed_status)

    def backwards(self, orm):
        deployed_nodes = orm['maasserver.Node'].objects.filter(status=deployed_status)
        deployed_nodes.update(status=allocated_status, netboot=False)
    ...
    models = {
        ...
        u'maasserver.filestorage': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "u'eb57886a-31ad-11e4-8ba5-9c4e363b1c94'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-eb52197a-31ad-11e4-8ba5-9c4e363b1c94'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1409558377L'}),
