...
COPY public.maasserver_operation (uuid, op_type, resource_id, resource_type, status, created_at, updated_at, started_at, finished_at, current_task, parameters, result_errors, is_bulk, parent_id, user_id) FROM stdin;
\.
...
ALTER TABLE ONLY public.maasserver_operation
    ADD CONSTRAINT maasserver_operation_pkey PRIMARY KEY (uuid);
