...
\restrict UOKxOJGANmoPzsmTG11ryAob8k120y9huuoshNVlIle6MDSkdbbXg2bM3U3Oct3
...
COPY public.maasserver_bootsourceselection (id, created, updated, os, release, boot_source_id, arch) FROM stdin;
\.
...
--
-- Name: maasserver_bootsourceselection maasserver_bootsourceselection_sourceid_os_release_arch_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maasserver_bootsourceselection
    ADD CONSTRAINT maasserver_bootsourceselection_sourceid_os_release_arch_unique UNIQUE (boot_source_id, os, release, arch);
...
\unrestrict UOKxOJGANmoPzsmTG11ryAob8k120y9huuoshNVlIle6MDSkdbbXg2bM3U3Oct3
