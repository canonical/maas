...
class TestTriggers(MAASServerTestCase):
    ...
    def test_register_all_triggers(self):
        ...
        triggers = [
            ...
            "maasserver_subnet_subnet_node_update_notify",
            "maasserver_fabric_fabric_node_update_notify",
            "maasserver_space_space_node_update_notify",
            "maasserver_vlan_vlan_node_update_notify",
            "maasserver_staticipaddress_ipaddress_node_update_notify",
