...
class TestNodeGroupToRackControllersRepository(
    RepositoryCommonTests[NodeGroupToRackController]
):
    @pytest.fixture
    def repository_instance(
        self, db_connection: AsyncConnection
    ) -> NodeGroupToRackControllersRepository:
        return NodeGroupToRackControllersRepository(
    ...
    ) -> list[NodeGroupToRackController]:
        pass
