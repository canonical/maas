...
def test_build_postgres_dsn_omits_sslmode(sslmode):
    params = {
...
def test_build_postgres_dsn_tcp_defaults_ssl_to_prefer():
    params = {
        "host": "dbhost.example.com",
        "port": "5432",
        "dbname": "testdb",
...
def test_build_postgres_dsn_omits_cert_params():
    params = {
        "host": "pg.internal",
        "port": "5432",
        "dbname": "maasdb",
...
def test_build_postgres_dsn_rootcert_only_omits_ssl_params():
    params = {
        "host": "pg.internal",
        "port": "5432",
        "dbname": "maasdb",
...
def test_build_postgres_dsn_no_certs_no_cert_params():
    params = {
        "host": "pg.internal",
        "port": "5432",
        "dbname": "maasdb",
