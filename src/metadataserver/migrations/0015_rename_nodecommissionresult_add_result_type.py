...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'metadataserver_nodecommissionresult', 'result_type',
                      self.gf('django.db.models.fields.IntegerField')(default=RESULT_TYPE.COMMISSIONING),
                      keep_default=False)
        db.rename_table(u'metadataserver_nodecommissionresult', u'metadataserver_noderesult')

    def backwards(self, orm):
        db.rename_table(u'metadataserver_noderesult', u'metadataserver_nodecommissionresult')
        # Deleting field 'NodeCommissionResult.status'
        db.delete_column(u'metadataserver_nodecommissionresult', 'result_type')
