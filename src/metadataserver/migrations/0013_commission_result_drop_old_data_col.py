...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NodeCommissionResult.data'
        db.delete_column(u'metadataserver_nodecommissionresult', 'data')


    def backwards(self, orm):
        # Adding field 'NodeCommissionResult.data'
        db.add_column(u'metadataserver_nodecommissionresult', 'data',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=1048576, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-5ccffa3e-1cc6-11e3-af0e-000c29baa6bf'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1379112403L'}),
