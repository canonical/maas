...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('metadataserver_nodecommissionresult', 'data')


    def backwards(self, orm):
        # Adding field 'NodeCommissionResult.data'
        db.add_column('metadataserver_nodecommissionresult', 'data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1048576, blank=True),
                      keep_default=False)
