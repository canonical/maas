...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('metadataserver_nodecommissionresult', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'NodeCommissionResult.name'
        db.alter_column('metadataserver_nodecommissionresult', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
