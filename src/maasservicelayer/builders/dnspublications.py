...
class DNSPublicationBuilder(ResourceBuilder):
    ...
    serial: int | Unset = Field(default=UNSET)
    source: str | Unset = Field(default=UNSET)
    update: str | Unset = Field(default=UNSET)
