...
class DNSDataBuilder(ResourceBuilder):
    ...
    dnsresource_id: int | Unset = Field(default=UNSET)
    rrdata: str | Unset = Field(default=UNSET)
    rrtype: str | Unset = Field(default=UNSET)
    ttl: int | None | Unset = Field(default=UNSET)
