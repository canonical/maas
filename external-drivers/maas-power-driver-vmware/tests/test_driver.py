...
"""Tests for the VMware power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh VMwarePowerDriver instance."""
    return VMwarePowerDriver()


class TestVMwarePowerDriver:
    """Tests for VMwarePowerDriver methods."""
