...
"""Tests for the RECS power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh RECSPowerDriver instance."""
    return RECSPowerDriver()


class TestRECSPowerDriver:
    """Tests for RECSPowerDriver methods."""
