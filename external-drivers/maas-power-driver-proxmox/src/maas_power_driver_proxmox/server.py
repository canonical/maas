...
"""HTTP server for the Proxmox power driver, listening on a UNIX domain socket."""
...
def main():
    """Start the Proxmox power driver HTTP server."""
    parser = argparse.ArgumentParser(description="Proxmox Power Driver Service")
    parser.add_argument(
        "command",
    ...
    PowerDriverHandler.driver = ProxmoxPowerDriver()
    ...
    logger.info("Proxmox power driver listening on %s", args.socket_path)
