...
"""HTTP server for the Microsoft OCS power driver, listening on a UNIX domain socket."""
...
from maas_power_driver_msftocs.driver import MSFTOCSPowerDriver
...
def main():
    """Start the Microsoft OCS power driver HTTP server."""
    parser = argparse.ArgumentParser(description="Microsoft OCS Power Driver Service")
    parser.add_argument(
        "command",
    ...
    PowerDriverHandler.driver = MSFTOCSPowerDriver()
    ...
    logger.info("Microsoft OCS power driver listening on %s", args.socket_path)
