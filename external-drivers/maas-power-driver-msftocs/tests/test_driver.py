...
"""Tests for the Microsoft OCS power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh MSFTOCSPowerDriver instance."""
    return MSFTOCSPowerDriver()


class TestMSFTOCSPowerDriver:
    """Tests for MSFTOCSPowerDriver methods."""
