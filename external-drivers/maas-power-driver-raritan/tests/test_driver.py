...
"""Tests for the Raritan power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh RaritanPowerDriver instance."""
    return RaritanPowerDriver()


class TestRaritanPowerDriver:
    """Tests for RaritanPowerDriver methods."""
