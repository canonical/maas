...
"""Tests for the Cisco UCSM power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh UCSMPowerDriver instance."""
    return UCSMPowerDriver()


class TestUCSMPowerDriver:
    """Tests for UCSMPowerDriver methods."""
