...
"""HTTP server for the HP Power Distribution Unit Wedge power driver, listening on a UNIX domain socket."""
...
from maas_power_driver_wedge.driver import WedgePowerDriver
...
def main():
    """Start the HP Power Distribution Unit Wedge power driver HTTP server."""
    parser = argparse.ArgumentParser(description="HP Power Distribution Unit Wedge Power Driver Service")
    parser.add_argument(
        "command",
    ...
    PowerDriverHandler.driver = WedgePowerDriver()
    ...
    logger.info("HP Power Distribution Unit Wedge power driver listening on %s", args.socket_path)
