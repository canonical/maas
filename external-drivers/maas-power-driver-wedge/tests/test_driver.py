...
"""Tests for the HP Power Distribution Unit Wedge power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh WedgePowerDriver instance."""
    return WedgePowerDriver()


class TestWedgePowerDriver:
    """Tests for WedgePowerDriver methods."""
