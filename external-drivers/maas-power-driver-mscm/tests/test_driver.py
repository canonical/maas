...
"""Tests for the IBM MSCM power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh MSCMPowerDriver instance."""
    return MSCMPowerDriver()


class TestMSCMPowerDriver:
    """Tests for MSCMPowerDriver methods."""
