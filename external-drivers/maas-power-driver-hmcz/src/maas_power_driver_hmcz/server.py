...
"""HTTP server for the IBM HMCz power driver, listening on a UNIX domain socket."""
...
from maas_power_driver_hmcz.driver import HMCzPowerDriver
...
def main():
    """Start the IBM HMCz power driver HTTP server."""
    parser = argparse.ArgumentParser(description="IBM HMCz Power Driver Service")
    parser.add_argument(
        "command",
    ...
    parser.add_argument(
        "--socket-path",
        default="/var/snap/maas-power-driver-hmcz/common/power-drivers/hmcz.sock",
    ...
    PowerDriverHandler.driver = HMCzPowerDriver()
    ...
    logger.info("IBM HMCz power driver listening on %s", args.socket_path)
