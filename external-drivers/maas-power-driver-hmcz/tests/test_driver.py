...
"""Tests for the IBM HMCz power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh HMCzPowerDriver instance."""
    return HMCzPowerDriver()


class TestHMCzPowerDriver:
    """Tests for HMCzPowerDriver methods."""
