...
"""HTTP server for the HP Moonshot power driver, listening on a UNIX domain socket."""
...
from maas_power_driver_moonshot.driver import MoonshotPowerDriver
...
def main():
    """Start the HP Moonshot power driver HTTP server."""
    parser = argparse.ArgumentParser(description="HP Moonshot Power Driver Service")
    parser.add_argument(
        "command",
    ...
    parser.add_argument(
        "--socket-path",
        default="/var/snap/maas-power-driver-moonshot/common/power-drivers/moonshot.sock",
    ...
    PowerDriverHandler.driver = MoonshotPowerDriver()
    ...
    logger.info("HP Moonshot power driver listening on %s", args.socket_path)
