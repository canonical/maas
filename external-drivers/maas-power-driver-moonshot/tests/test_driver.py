...
"""Tests for the HP Moonshot power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh MoonshotPowerDriver instance."""
    return MoonshotPowerDriver()


class TestMoonshotPowerDriver:
    """Tests for MoonshotPowerDriver methods."""
