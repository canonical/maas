...
"""Tests for the Intel AMT power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh AMTPowerDriver instance."""
    return AMTPowerDriver()


class TestAMTPowerDriver:
    """Tests for AMTPowerDriver methods."""
