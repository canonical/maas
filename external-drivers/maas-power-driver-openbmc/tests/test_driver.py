...
"""Tests for the OpenBMC power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh OpenBMCPowerDriver instance."""
    return OpenBMCPowerDriver()


class TestOpenBMCPowerDriver:
    """Tests for OpenBMCPowerDriver methods."""
