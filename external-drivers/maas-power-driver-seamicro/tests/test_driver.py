...
"""Tests for the SeaMicro power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh SeaMicroPowerDriver instance."""
    return SeaMicroPowerDriver()


class TestSeaMicroPowerDriver:
    """Tests for SeaMicroPowerDriver methods."""
