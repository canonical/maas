...
"""HTTP server for the SeaMicro power driver, listening on a UNIX domain socket."""
...
from maas_power_driver_seamicro.driver import SeaMicroPowerDriver
...
def main():
    """Start the SeaMicro power driver HTTP server."""
    parser = argparse.ArgumentParser(description="SeaMicro Power Driver Service")
    parser.add_argument(
        "command",
    ...
    parser.add_argument(
        "--socket-path",
        default="/var/snap/maas-power-driver-seamicro/common/power-drivers/seamicro.sock",
    ...
    PowerDriverHandler.driver = SeaMicroPowerDriver()
    ...
    logger.info("SeaMicro power driver listening on %s", args.socket_path)
