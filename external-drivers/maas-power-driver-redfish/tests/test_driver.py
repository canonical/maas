...
"""Tests for the Redfish power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh RedfishPowerDriver instance."""
    return RedfishPowerDriver()


class TestRedfishPowerDriver:
    """Tests for RedfishPowerDriver methods."""
