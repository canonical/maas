...
"""Tests for the Eaton power driver."""
...
@pytest.fixture
def driver():
    """Create a fresh EatonPowerDriver instance."""
    return EatonPowerDriver()


class TestEatonPowerDriver:
    """Tests for EatonPowerDriver methods."""
